// This file was generated based on /usr/local/share/uno/Packages/Fuse.Elements/0.41.3/triggers/$.uno.
...
struct LayoutTransition : uObject
{
    ...
    static bool GetPositionChange(::g::Fuse::Visual* n, ::g::Uno::Float2* oldPos, ::g::Uno::Float2* newPos);
    static bool GetSizeChange(::g::Fuse::Visual* n, ::g::Uno::Float2* oldSize, ::g::Uno::Float2* newSize);
    static ::g::Uno::Float3 GetWorldPositionChange(::g::Fuse::Visual* n);
    static void SetPositionChange(::g::Fuse::Visual* n, ::g::Uno::Float2 oldPos, ::g::Uno::Float2 newPos);
    static void SetSizeChange(::g::Fuse::Visual* n, ::g::Uno::Float2 oldSize, ::g::Uno::Float2 newSize);
    static void SetWorldPositionChange(::g::Fuse::Visual* n, ::g::Uno::Float3 change);
