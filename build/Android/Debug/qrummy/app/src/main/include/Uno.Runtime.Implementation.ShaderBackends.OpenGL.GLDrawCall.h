// This file was generated based on /usr/local/share/uno/Packages/UnoCore/0.41.5/source/uno/runtime/implementation/shaderbackends/opengl/$.uno.
...
struct GLDrawCall
{
    ...
    void Sampler6(int index, ::g::Uno::Graphics::VideoTexture* value);
    ...
    void Uniform13(int index, uArray* value);
    void Use();
    bool WriteAlpha();
