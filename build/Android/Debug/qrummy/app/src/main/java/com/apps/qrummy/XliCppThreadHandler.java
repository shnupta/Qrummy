...
public class XliCppThreadHandler extends Handler {
	...
	private void handleRepeating(Message msg)
	{
		if (msg.arg1 == xliCallbackIndex) {
            com.apps.qrummy.ActivityNativeEntryPoints.cppTimerCallback(msg.arg1); // {TODO} this should own callback
			...
			com.apps.qrummy.ActivityNativeEntryPoints.cppTimerCallback(msg.arg1);
