...
// /usr/local/share/uno/Packages/Fuse.Drawing/0.41.3/$.uno
// -------------------------------------------------------
...
static void Brush_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing/0.41.3/$.uno");
...
{
    if (!IsPinned())
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[1/*"Brush is no...*/], this, ::STRINGS[2/*"/usr/local/...*/], 152, ::STRINGS[3/*"Prepare"*/]);
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.41.3/drawing/$.uno
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing/0.41.3/brushes/$.uno
// ---------------------------------------------------------------
