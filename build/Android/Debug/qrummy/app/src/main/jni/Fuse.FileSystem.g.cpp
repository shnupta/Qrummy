...
// /usr/local/share/uno/Packages/Fuse.FileSystem/0.41.3/$.uno
// ----------------------------------------------------------
...
{
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetCacheDirectory284", "()Ljava/lang/String;");
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetExternalCacheDirectory285", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetExternalFilesDirectory286", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetFilesDirectory287", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
...
// private sealed class FileSystemOperations.Closure<T1, TResult> :1221
// {
...
// public Closure(Uno.Func<T1, TResult> del, T1 arg1) :1226
...
// public Closure New(Uno.Func<T1, TResult> del, T1 arg1) :1226
...
// private sealed class FileSystemOperations.Closure<T1, T2, TResult> :1239
// {
...
// public Closure(Uno.Func<T1, T2, TResult> del, T1 arg1, T2 arg2) :1245
...
// public Closure New(Uno.Func<T1, T2, TResult> del, T1 arg1, T2 arg2) :1245
...
// /usr/local/share/uno/Packages/Fuse.FileSystem/0.41.3/uno/io/$.uno
// -----------------------------------------------------------------
...
// public sealed class FileSystemModule :116
// {
static void FileSystemModule_build(uType* type)
{
    ...
    ::TYPES[27] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(7/*ToArray<object>*/, uObject_typeof(), NULL);
    ...
    type->MethodTypes[1]->SetPrecalc(
        ::TYPES[28/*Uno.Collections.EnumerableExtensions*/]->MakeMethod(3/*OfType<T, object>*/, type->MethodTypes[1]->U(0), uObject_typeof(), NULL),
...
// public FileSystemModule() :121
void FileSystemModule__ctor_2_fn(FileSystemModule* __this)
{
    __this->ctor_2();
}

// private Uno.Threading.Future<Fuse.FileSystem.Nothing> AppendTextToFile(object[] args) :190
...
// private object AppendTextToFileSync(Fuse.Scripting.Context context, object[] args) :211
...
// public Uno.Threading.Future<Fuse.FileSystem.Nothing> CreateDirectory(object[] args) :238
...
// public object CreateDirectorySync(Fuse.Scripting.Context context, object[] args) :256
...
// private Uno.Threading.Future<Fuse.FileSystem.Nothing> Delete(object[] args) :282
...
// private object DeleteSync(Fuse.Scripting.Context context, object[] args) :302
...
// private Uno.Threading.Future<bool> Exists(object[] args) :328
...
// private Uno.Collections.Dictionary<string, string> GetAndroidPaths() :363
...
// private static T GetArg<T>(object[] args, int index, string error) :920
...
// private object GetDirectoryInfoSync(Fuse.Scripting.Context context, object[] args) :456
...
// private Uno.Threading.Future<Fuse.FileSystem.FileSystemInfo> GetFileInfo(object[] args) :489
...
// private object GetFileInfoSync(Fuse.Scripting.Context context, object[] args) :516
...
// private static string GetPathFromArgs(object[] args) :935
void FileSystemModule__GetPathFromArgs_fn(uArray* args, uString** __retval)
{
    *__retval = FileSystemModule::GetPathFromArgs(args);
}

// private Uno.Threading.Future<string[]> ListDirectories(object[] args) :563
...
// private object ListDirectoriesSync(Fuse.Scripting.Context context, object[] args) :583
...
// private Uno.Threading.Future<string[]> ListEntries(object[] args) :607
...
// private object ListEntriesSync(Fuse.Scripting.Context context, object[] args) :627
...
// private Uno.Threading.Future<string[]> ListFiles(object[] args) :651
...
// private object ListFilesSync(Fuse.Scripting.Context context, object[] args) :671
...
// private Uno.Threading.Future<Fuse.FileSystem.Nothing> Move(object[] args) :697
...
// private object MoveSync(Fuse.Scripting.Context context, object[] args) :718
...
// public FileSystemModule New() :121
void FileSystemModule__New2_fn(FileSystemModule** __retval)
{
    *__retval = FileSystemModule::New2();
}

// private Uno.Threading.Future<byte[]> ReadBufferFromFile(object[] args) :745
...
// private object ReadBufferFromFileSync(Fuse.Scripting.Context context, object[] args) :764
...
// private Uno.Threading.Future<string> ReadTextFromFile(object[] args) :788
...
// private object ReadTextFromFileSync(Fuse.Scripting.Context context, object[] args) :808
...
// private static Fuse.Scripting.Array ToScriptingArray<T>(Fuse.Scripting.Context context, T[] sourceArray) :949
...
// private static object ToScriptingDate(Fuse.Scripting.Context context, Uno.Time.ZonedDateTime time) :972
...
// private static Fuse.Scripting.Object ToScriptingObject(Fuse.Scripting.Context context, Fuse.FileSystem.FileSystemInfo info) :956
...
// private static Fuse.Scripting.Object ToScriptingObject<T>(Fuse.Scripting.Context context, Uno.Collections.Dictionary<string, T> dict) :980
...
// private Uno.Threading.Future<Fuse.FileSystem.Nothing> WriteBufferToFile(object[] args) :837
...
// private object WriteBufferToFileSync(Fuse.Scripting.Context context, object[] args) :862
...
// private Uno.Threading.Future<Fuse.FileSystem.Nothing> WriteTextToFile(object[] args) :890
...
// private object WriteTextToFileSync(Fuse.Scripting.Context context, object[] args) :911
...
// public FileSystemModule() [instance] :121
...
// private Uno.Threading.Future<Fuse.FileSystem.Nothing> AppendTextToFile(object[] args) [instance] :190
...
// private object AppendTextToFileSync(Fuse.Scripting.Context context, object[] args) [instance] :211
...
// public Uno.Threading.Future<Fuse.FileSystem.Nothing> CreateDirectory(object[] args) [instance] :238
...
// public object CreateDirectorySync(Fuse.Scripting.Context context, object[] args) [instance] :256
...
// private Uno.Threading.Future<Fuse.FileSystem.Nothing> Delete(object[] args) [instance] :282
...
// private object DeleteSync(Fuse.Scripting.Context context, object[] args) [instance] :302
...
// private Uno.Threading.Future<bool> Exists(object[] args) [instance] :328
...
// private object GetDirectoryInfoSync(Fuse.Scripting.Context context, object[] args) [instance] :456
...
// private Uno.Threading.Future<Fuse.FileSystem.FileSystemInfo> GetFileInfo(object[] args) [instance] :489
...
// private object GetFileInfoSync(Fuse.Scripting.Context context, object[] args) [instance] :516
...
// private Uno.Threading.Future<string[]> ListDirectories(object[] args) [instance] :563
...
// private object ListDirectoriesSync(Fuse.Scripting.Context context, object[] args) [instance] :583
...
// private Uno.Threading.Future<string[]> ListEntries(object[] args) [instance] :607
...
// private object ListEntriesSync(Fuse.Scripting.Context context, object[] args) [instance] :627
...
// private Uno.Threading.Future<string[]> ListFiles(object[] args) [instance] :651
...
// private object ListFilesSync(Fuse.Scripting.Context context, object[] args) [instance] :671
...
// private Uno.Threading.Future<Fuse.FileSystem.Nothing> Move(object[] args) [instance] :697
...
// private object MoveSync(Fuse.Scripting.Context context, object[] args) [instance] :718
...
// private Uno.Threading.Future<byte[]> ReadBufferFromFile(object[] args) [instance] :745
...
// private object ReadBufferFromFileSync(Fuse.Scripting.Context context, object[] args) [instance] :764
...
// private Uno.Threading.Future<string> ReadTextFromFile(object[] args) [instance] :788
...
// private object ReadTextFromFileSync(Fuse.Scripting.Context context, object[] args) [instance] :808
...
// private Uno.Threading.Future<Fuse.FileSystem.Nothing> WriteBufferToFile(object[] args) [instance] :837
...
// private object WriteBufferToFileSync(Fuse.Scripting.Context context, object[] args) [instance] :862
...
// private Uno.Threading.Future<Fuse.FileSystem.Nothing> WriteTextToFile(object[] args) [instance] :890
...
// private object WriteTextToFileSync(Fuse.Scripting.Context context, object[] args) [instance] :911
...
// private static T GetArg<T>(object[] args, int index, string error) [static] :920
...
// private static string GetPathFromArgs(object[] args) [static] :935
...
// public FileSystemModule New() [static] :121
...
// private static Fuse.Scripting.Array ToScriptingArray<T>(Fuse.Scripting.Context context, T[] sourceArray) [static] :949
...
// private static object ToScriptingDate(Fuse.Scripting.Context context, Uno.Time.ZonedDateTime time) [static] :972
...
// private static Fuse.Scripting.Object ToScriptingObject(Fuse.Scripting.Context context, Fuse.FileSystem.FileSystemInfo info) [static] :956
...
// private static Fuse.Scripting.Object ToScriptingObject<T>(Fuse.Scripting.Context context, Uno.Collections.Dictionary<string, T> dict) [static] :980
...
// internal sealed class FileSystemOperations :1002
// {
static void FileSystemOperations_build(uType* type)
{
    ...
    ::TYPES[47] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(7/*ToArray<string>*/, ::g::Uno::String_typeof(), NULL);
    ::TYPES[48] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(5/*Select<string, string>*/, ::g::Uno::String_typeof(), ::g::Uno::String_typeof(), NULL);
...
// public FileSystemOperations() :1007
void FileSystemOperations__ctor__fn(FileSystemOperations* __this)
{
    __this->ctor_();
}

// public FileSystemOperations(Uno.Threading.IDispatcher dispatcher) :1010
void FileSystemOperations__ctor_1_fn(FileSystemOperations* __this, uObject* dispatcher)
{
    __this->ctor_1(dispatcher);
}

// public Uno.Threading.Future<Fuse.FileSystem.Nothing> AppendTextToFile(string path, string text) :1016
...
// public Fuse.FileSystem.Nothing AppendTextToFileSync(string path, string text) :1022
...
// public Uno.Threading.Future<Fuse.FileSystem.Nothing> CreateDirectory(string path) :1029
...
// public Fuse.FileSystem.Nothing CreateDirectorySync(string path) :1035
...
// public Uno.Threading.Future<Fuse.FileSystem.Nothing> Delete(string path, bool recursive) :1042
...
// public Fuse.FileSystem.Nothing DeleteSync(string path, bool recursive) :1048
...
// public Uno.Threading.Future<bool> Exists(string path) :1059
...
// public bool ExistsSync(string path) :1065
...
// public Uno.Threading.Future<Fuse.FileSystem.FileSystemInfo> GetDirectoryInfo(string path) :1073
...
// public Fuse.FileSystem.FileSystemInfo GetDirectoryInfoSync(string path) :1079
...
// public Uno.Threading.Future<Fuse.FileSystem.FileSystemInfo> GetFileInfo(string path) :1085
...
// public Fuse.FileSystem.FileSystemInfo GetFileInfoSync(string path) :1091
...
// public Uno.Threading.Future<string[]> ListDirectories(string path) :1097
...
// public string[] ListDirectoriesSync(string path) :1103
...
// public Uno.Threading.Future<string[]> ListEntries(string path) :1109
...
// public string[] ListEntriesSync(string path) :1115
...
// public Uno.Threading.Future<string[]> ListFiles(string path) :1121
...
// public string[] ListFilesSync(string path) :1127
...
// public Uno.Threading.Future<Fuse.FileSystem.Nothing> Move(string source, string destination) :1133
...
// public Fuse.FileSystem.Nothing MoveSync(string source, string destination) :1139
...
// public FileSystemOperations New() :1007
void FileSystemOperations__New1_fn(FileSystemOperations** __retval)
{
    *__retval = FileSystemOperations::New1();
}

// public Uno.Threading.Future<byte[]> ReadBufferFromFile(string path) :1149
...
// public byte[] ReadBufferFromFileSync(string path) :1155
...
// public Uno.Threading.Future<string> ReadTextFromFile(string path) :1162
...
// public string ReadTextFromFileSync(string path) :1168
...
// private Uno.Threading.Future<T> RunTask<T>(Uno.Func<T> del) :1201
...
// private Uno.Threading.Future<TResult> RunTask<T1, TResult>(Uno.Func<T1, TResult> del, T1 arg1) :1209
...
// private Uno.Threading.Future<TResult> RunTask<T1, T2, TResult>(Uno.Func<T1, T2, TResult> del, T1 arg1, T2 arg2) :1215
...
// public Uno.Threading.Future<Fuse.FileSystem.Nothing> WriteBufferToFile(string path, byte[] data) :1175
...
// public Fuse.FileSystem.Nothing WriteBufferToFileSync(string path, byte[] data) :1181
...
// public Uno.Threading.Future<Fuse.FileSystem.Nothing> WriteTextToFile(string path, string text) :1188
...
// public Fuse.FileSystem.Nothing WriteTextToFileSync(string path, string text) :1194
...
// public FileSystemOperations() [instance] :1007
void FileSystemOperations::ctor_()
{
    ctor_1(NULL);
}

// public FileSystemOperations(Uno.Threading.IDispatcher dispatcher) [instance] :1010
void FileSystemOperations::ctor_1(uObject* dispatcher)
{
    _dispatcher = dispatcher;
}

// public Uno.Threading.Future<Fuse.FileSystem.Nothing> AppendTextToFile(string path, string text) [instance] :1016
...
// public Fuse.FileSystem.Nothing AppendTextToFileSync(string path, string text) [instance] :1022
...
// public Uno.Threading.Future<Fuse.FileSystem.Nothing> CreateDirectory(string path) [instance] :1029
...
// public Fuse.FileSystem.Nothing CreateDirectorySync(string path) [instance] :1035
...
// public Uno.Threading.Future<Fuse.FileSystem.Nothing> Delete(string path, bool recursive) [instance] :1042
...
// public Fuse.FileSystem.Nothing DeleteSync(string path, bool recursive) [instance] :1048
...
// public Uno.Threading.Future<bool> Exists(string path) [instance] :1059
...
// public bool ExistsSync(string path) [instance] :1065
bool FileSystemOperations::ExistsSync(uString* path)
{
    return ::g::Uno::IO::File::Exists(path) || ::g::Uno::IO::Directory::Exists(path);
}

// public Uno.Threading.Future<Fuse.FileSystem.FileSystemInfo> GetDirectoryInfo(string path) [instance] :1073
...
// public Fuse.FileSystem.FileSystemInfo GetDirectoryInfoSync(string path) [instance] :1079
...
// public Uno.Threading.Future<Fuse.FileSystem.FileSystemInfo> GetFileInfo(string path) [instance] :1085
...
// public Fuse.FileSystem.FileSystemInfo GetFileInfoSync(string path) [instance] :1091
...
// public Uno.Threading.Future<string[]> ListDirectories(string path) [instance] :1097
...
// public string[] ListDirectoriesSync(string path) [instance] :1103
...
// public Uno.Threading.Future<string[]> ListEntries(string path) [instance] :1109
...
// public string[] ListEntriesSync(string path) [instance] :1115
...
// public Uno.Threading.Future<string[]> ListFiles(string path) [instance] :1121
...
// public string[] ListFilesSync(string path) [instance] :1127
...
// public Uno.Threading.Future<Fuse.FileSystem.Nothing> Move(string source, string destination) [instance] :1133
...
// public Fuse.FileSystem.Nothing MoveSync(string source, string destination) [instance] :1139
...
// public Uno.Threading.Future<byte[]> ReadBufferFromFile(string path) [instance] :1149
...
// public byte[] ReadBufferFromFileSync(string path) [instance] :1155
uArray* FileSystemOperations::ReadBufferFromFileSync(uString* path)
{
    return ::g::Uno::IO::File::ReadAllBytes(path);
}

// public Uno.Threading.Future<string> ReadTextFromFile(string path) [instance] :1162
...
// public string ReadTextFromFileSync(string path) [instance] :1168
uString* FileSystemOperations::ReadTextFromFileSync(uString* path)
{
    return ::g::Uno::IO::File::ReadAllText(path);
}

// private Uno.Threading.Future<T> RunTask<T>(Uno.Func<T> del) [instance] :1201
...
// public Uno.Threading.Future<Fuse.FileSystem.Nothing> WriteBufferToFile(string path, byte[] data) [instance] :1175
...
// public Fuse.FileSystem.Nothing WriteBufferToFileSync(string path, byte[] data) [instance] :1181
...
// public Uno.Threading.Future<Fuse.FileSystem.Nothing> WriteTextToFile(string path, string text) [instance] :1188
...
// public Fuse.FileSystem.Nothing WriteTextToFileSync(string path, string text) [instance] :1194
...
// public FileSystemOperations New() [static] :1007
...
// internal sealed class Nothing :1319
// {
...
// public static string NormalizePath(string path) :1336
void PathTools__NormalizePath_fn(uString* path, uString** __retval)
{
    *__retval = PathTools::NormalizePath(path);
}

// public static string NormalizePath(string path) [static] :1336
...
// public static string GetDataDirectory() [static] :1364
uString* UnifiedPaths::GetDataDirectory()
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetDataDirectory289", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
