...
// /usr/local/share/uno/Packages/Fuse.Reactive/0.41.3/fusejs/$.uno
// ---------------------------------------------------------------
...
static void Builtins_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("fuse-builtins: es6-promise");
    ::STRINGS[3] = uString::Const("FuseJS/Observable");
    ::STRINGS[4] = uString::Const("Polyfills/Window");
...
// private static bool IsModule(object module) :48
...
// internal void UpdateModules(Fuse.Scripting.Context context) :63
...
void Builtins::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    ::g::Fuse::Scripting::Function* setTimout = uCast< ::g::Fuse::Scripting::Function*>(uPtr(context)->Evaluate(::STRINGS[1/*"fuse-builti...*/], uPtr(::g::FuseReactive_bundle::setTimeout1c492e5d())->ReadAllText()), ::TYPES[2/*Fuse.Scripting.Function*/]);
    ...
    context->Evaluate(::STRINGS[2/*"fuse-builti...*/], uPtr(::g::FuseReactive_bundle::es6promiseab78409a())->ReadAllText());
    Observable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseReactive_bundle::Observablebf595342()))->EvaluateExports(context, ::STRINGS[3/*"FuseJS/Obse...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
    EventEmitter = ::g::Fuse::Scripting::EventEmitterModule::GetConstructor(context);
    res = NULL;

    if (::g::Uno::UX::Resource::TryFindGlobal(::STRINGS[4/*"Polyfills/W...*/], uDelegate::New(::TYPES[0/*Uno.Predicate<object>*/], (void*)Builtins__IsModule_fn), &res))
        uPtr(uCast< ::g::Fuse::Scripting::Module*>(res, ::TYPES[4/*Fuse.Scripting.Module*/]))->Evaluate1(context, ::STRINGS[4/*"Polyfills/W...*/]);
}

// internal void UpdateModules(Fuse.Scripting.Context context) [instance] :63
...
// private static bool IsModule(object module) [static] :48
...
// private sealed class TimerModule.CallbackClosure :762
// {
static void TimerModule__CallbackClosure_build(uType* type)
{
    ::STRINGS[5] = uString::Const("func");
    ::STRINGS[6] = uString::Const("args");
    type->SetFields(0,
...
// public CallbackClosure(Fuse.Scripting.Context context, Fuse.Scripting.Function func, object[] args) :768
...
// public void Callback() :778
void TimerModule__CallbackClosure__Callback_fn(TimerModule__CallbackClosure* __this)
{
    __this->Callback();
}

// public CallbackClosure New(Fuse.Scripting.Context context, Fuse.Scripting.Function func, object[] args) :768
...
// public CallbackClosure(Fuse.Scripting.Context context, Fuse.Scripting.Function func, object[] args) [instance] :768
void TimerModule__CallbackClosure::ctor_(::g::Fuse::Scripting::Context* context, ::g::Fuse::Scripting::Function* func, uArray* args)
{
    if (func == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[5/*"func"*/]));

    if (args == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[6/*"args"*/]));
...
// public void Callback() [instance] :778
void TimerModule__CallbackClosure::Callback()
{
    uPtr(_func)->Call(_args);
}

// public CallbackClosure New(Fuse.Scripting.Context context, Fuse.Scripting.Function func, object[] args) [static] :768
...
// public sealed class Email :603
// {
static void Email_build(uType* type)
{
    ::STRINGS[7] = uString::Const("FuseJS/Email");
    ::STRINGS[8] = uString::Const("compose");
...
void Email::ctor_2()
{
    ...
    ::g::Uno::UX::Resource::SetGlobalKey(Email::_instance_ = this, ::STRINGS[7/*"FuseJS/Email"*/]);
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[8/*"compose"*/], uDelegate::New(::TYPES[5/*Fuse.Scripting.NativeCallback*/], (void*)Email__Compose_fn)));
}

// public static object Compose(Fuse.Scripting.Context context, object[] args) [static] :630
uObject* Email::Compose(::g::Fuse::Scripting::Context* context, uArray* args)
{
    uString* to = uCast<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[6/*string*/]);
    uString* cc = uCast<uString*>(args->Strong<uObject*>(1), ::TYPES[6/*string*/]);
    uString* bcc = uCast<uString*>(args->Strong<uObject*>(2), ::TYPES[6/*string*/]);
    uString* subject = uCast<uString*>(args->Strong<uObject*>(3), ::TYPES[6/*string*/]);
    uString* message = uCast<uString*>(args->Strong<uObject*>(4), ::TYPES[6/*string*/]);
    ::g::Fuse::Launcher::LaunchEmail(to, cc, bcc, subject, message);
    return NULL;
}

// public Email New() [static] :607
Email* Email::New2()
{
...
// private sealed class Http.FunctionClosure :241
// {
...
// public FunctionClosure(Fuse.Scripting.Context context, Uno.Func<Fuse.Scripting.Context, object[], object> callback) :246
...
// public FunctionClosure New(Fuse.Scripting.Context context, Uno.Func<Fuse.Scripting.Context, object[], object> callback) :246
...
// public FunctionClosure(Fuse.Scripting.Context context, Uno.Func<Fuse.Scripting.Context, object[], object> callback) [instance] :246
...
// public Fuse.Scripting.Callback get_Callback() [instance] :259
uDelegate* Http__FunctionClosure::Callback()
{
    return uDelegate::New(::TYPES[7/*Fuse.Scripting.Callback*/], (void*)Http__FunctionClosure__function_fn, this);
}

// private object function(object[] args) [instance] :252
uObject* Http__FunctionClosure::function(uArray* args)
{
    return uPtr(_callback)->Invoke(2, (::g::Fuse::Scripting::Context*)_context, args);
}

// public FunctionClosure New(Fuse.Scripting.Context context, Uno.Func<Fuse.Scripting.Context, object[], object> callback) [static] :246
...
// private sealed class Http.FuseJSHttpClient :263
// {
...
// public FuseJSHttpClient(Fuse.Scripting.Context context) :270
void Http__FuseJSHttpClient__ctor__fn(Http__FuseJSHttpClient* __this, ::g::Fuse::Scripting::Context* context)
{
    __this->ctor_(context);
}

// private object CreateRequest(object[] args) :279
...
// public FuseJSHttpClient New(Fuse.Scripting.Context context) :270
...
void Http__FuseJSHttpClient::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    uPtr(Obj())->Item(::STRINGS[9/*"createRequest"*/], uDelegate::New(::TYPES[7/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpClient__CreateRequest_fn, this));
}

// private object CreateRequest(object[] args) [instance] :279
...
// public generated Fuse.Scripting.Object get_Obj() [instance] :265
::g::Fuse::Scripting::Object* Http__FuseJSHttpClient::Obj()
{
    return _Obj;
}

// private generated void set_Obj(Fuse.Scripting.Object value) [instance] :265
void Http__FuseJSHttpClient::Obj(::g::Fuse::Scripting::Object* value)
{
    _Obj = value;
}

// public FuseJSHttpClient New(Fuse.Scripting.Context context) [static] :270
...
// private sealed class Http.FuseJSHttpRequest :288
// {
static void Http__FuseJSHttpRequest_build(uType* type)
{
    ...
    ::TYPES[8] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Net::Http::HttpMessageHandlerRequest_typeof(), NULL);
    ::TYPES[9] = ::g::Uno::Action2_typeof()->MakeType(::g::Uno::Net::Http::HttpMessageHandlerRequest_typeof(), ::g::Uno::String_typeof(), NULL);
    ::TYPES[10] = ::g::Uno::Action4_typeof()->MakeType(::g::Uno::Net::Http::HttpMessageHandlerRequest_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Bool_typeof(), NULL);
    ::TYPES[7] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[11] = ::g::Fuse::Scripting::JSCallback_typeof()->MakeMethod(0/*FromAction<int>*/, ::g::Uno::Int_typeof(), NULL);
    ::TYPES[12] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Int_typeof(), NULL);
    ::TYPES[13] = ::g::Uno::Action_typeof();
    ::TYPES[14] = ::g::Fuse::Scripting::JSCallback_typeof()->MakeMethod(1/*FromAction<string, string>*/, ::g::Uno::String_typeof(), ::g::Uno::String_typeof(), NULL);
    ::TYPES[15] = ::g::Uno::Action2_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof(), NULL);
    ::TYPES[16] = ::g::Fuse::Scripting::JSCallback_typeof()->MakeMethod(3/*FromFunc<string, string>*/, ::g::Uno::String_typeof(), ::g::Uno::String_typeof(), NULL);
    ::TYPES[17] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof(), NULL);
    ::TYPES[18] = ::g::Fuse::Scripting::JSCallback_typeof()->MakeMethod(2/*FromFunc<string>*/, ::g::Uno::String_typeof(), NULL);
    ::TYPES[19] = ::g::Uno::Func_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[20] = ::g::Fuse::Scripting::JSCallback_typeof()->MakeMethod(2/*FromFunc<int>*/, ::g::Uno::Int_typeof(), NULL);
    ...
    type->SetFields(0,
        ...
        ::TYPES[23/*int*/], offsetof(::g::Fuse::Reactive::FuseJS::Http__FuseJSHttpRequest, _cachedResponseStatus), 0,
...
// public FuseJSHttpRequest(Fuse.Scripting.Context context, Uno.Net.Http.HttpMessageHandlerRequest req) :301
...
// private object GetResponseContentByteArray(object[] args) :428
...
// private string GetResponseContentString(object[] args) :413
...
// private string GetResponseHeader(string key) :398
...
// private string GetResponseHeaders() :388
...
// private object GetResponseReasonPhrase(object[] args) :538
...
// private int GetResponseStatus() :528
...
// private object GetResponseType(object[] args) :556
...
// private object GetState(object[] args) :523
...
// public FuseJSHttpRequest New(Fuse.Scripting.Context context, Uno.Net.Http.HttpMessageHandlerRequest req) :301
...
// private void OnProgress(Uno.Net.Http.HttpMessageHandlerRequest res, int current, int total, bool hastotal) :482
...
// private void OnStateChanged(Uno.Net.Http.HttpMessageHandlerRequest res) :467
...
// private void OnTimeout(Uno.Net.Http.HttpMessageHandlerRequest res) :459
...
// private object SendAsync(object[] args) :489
...
// private void SetHeader(string key, string value) :370
...
// private object SetResponseType(object[] args) :543
...
// private void SetTimeout(int timeout) :376
void Http__FuseJSHttpRequest__SetTimeout_fn(Http__FuseJSHttpRequest* __this, int* timeout)
{
    __this->SetTimeout(*timeout);
}

// public FuseJSHttpRequest(Fuse.Scripting.Context context, Uno.Net.Http.HttpMessageHandlerRequest req) [instance] :301
void Http__FuseJSHttpRequest::ctor_(::g::Fuse::Scripting::Context* context, ::g::Uno::Net::Http::HttpMessageHandlerRequest* req)
{
    _req = req;
    Obj(uPtr(context)->NewObject());
    uPtr(_req)->add_Aborted(uDelegate::New(::TYPES[8/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/], (void*)Http__FuseJSHttpRequest__OnAbort_fn, this));
    uPtr(_req)->add_Error(uDelegate::New(::TYPES[9/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, string>*/], (void*)Http__FuseJSHttpRequest__OnError_fn, this));
    uPtr(_req)->add_Timeout(uDelegate::New(::TYPES[8/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/], (void*)Http__FuseJSHttpRequest__OnTimeout_fn, this));
    uPtr(_req)->add_Done(uDelegate::New(::TYPES[8/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/], (void*)Http__FuseJSHttpRequest__OnDone_fn, this));
    uPtr(_req)->add_StateChanged(uDelegate::New(::TYPES[8/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/], (void*)Http__FuseJSHttpRequest__OnStateChanged_fn, this));
    uPtr(_req)->add_Progress(uDelegate::New(::TYPES[10/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, int, int, bool>*/], (void*)Http__FuseJSHttpRequest__OnProgress_fn, this));
    uPtr(Obj())->Item(::STRINGS[10/*"enableCache"*/], uDelegate::New(::TYPES[7/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__EnableCache_fn, this));
    uPtr(Obj())->Item(::STRINGS[11/*"setTimeout"*/], ::g::Fuse::Scripting::JSCallback::FromAction1(::TYPES[11/*Fuse.Scripting.JSCallback.FromAction<int>*/], uDelegate::New(::TYPES[12/*Uno.Action<int>*/], (void*)Http__FuseJSHttpRequest__SetTimeout_fn, this)));
    uPtr(Obj())->Item(::STRINGS[12/*"setResponse...*/], uDelegate::New(::TYPES[7/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__SetResponseType_fn, this));
    uPtr(Obj())->Item(::STRINGS[13/*"getResponse...*/], uDelegate::New(::TYPES[7/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetResponseType_fn, this));
    uPtr(Obj())->Item(::STRINGS[14/*"sendAsync"*/], uDelegate::New(::TYPES[7/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__SendAsync_fn, this));
    uPtr(Obj())->Item(::STRINGS[15/*"abort"*/], ::g::Fuse::Scripting::JSCallback::FromAction(uDelegate::New(::TYPES[13/*Uno.Action*/], (void*)Http__FuseJSHttpRequest__Abort_fn, this)));
    uPtr(Obj())->Item(::STRINGS[16/*"setHeader"*/], ::g::Fuse::Scripting::JSCallback::FromAction2(::TYPES[14/*Fuse.Scripting.JSCallback.FromAction<string, string>*/], uDelegate::New(::TYPES[15/*Uno.Action<string, string>*/], (void*)Http__FuseJSHttpRequest__SetHeader_fn, this)));
    uPtr(Obj())->Item(::STRINGS[17/*"getResponse...*/], ::g::Fuse::Scripting::JSCallback::FromFunc1(::TYPES[16/*Fuse.Scripting.JSCallback.FromFunc<string, string>*/], uDelegate::New(::TYPES[17/*Uno.Func<string, string>*/], (void*)Http__FuseJSHttpRequest__GetResponseHeader_fn, this)));
    uPtr(Obj())->Item(::STRINGS[18/*"getResponse...*/], ::g::Fuse::Scripting::JSCallback::FromFunc(::TYPES[18/*Fuse.Scripting.JSCallback.FromFunc<string>*/], uDelegate::New(::TYPES[19/*Uno.Func<string>*/], (void*)Http__FuseJSHttpRequest__GetResponseHeaders_fn, this)));
    uPtr(Obj())->Item(::STRINGS[19/*"getState"*/], uDelegate::New(::TYPES[7/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetState_fn, this));
    uPtr(Obj())->Item(::STRINGS[20/*"getResponse...*/], ::g::Fuse::Scripting::JSCallback::FromFunc(::TYPES[20/*Fuse.Scripting.JSCallback.FromFunc<int>*/], uDelegate::New(::TYPES[21/*Uno.Func<int>*/], (void*)Http__FuseJSHttpRequest__GetResponseStatus_fn, this)));
    uPtr(Obj())->Item(::STRINGS[21/*"getResponse...*/], uDelegate::New(::TYPES[7/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetResponseReasonPhrase_fn, this));
    uPtr(Obj())->Item(::STRINGS[22/*"getResponse...*/], uDelegate::New(::TYPES[7/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetResponseContentString_fn, this));
    uPtr(Obj())->Item(::STRINGS[23/*"getResponse...*/], uDelegate::New(::TYPES[7/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetResponseContentByteArray_fn, this));
}

// private void Abort() [instance] :364
...
// private void CheckIsAttached() [instance] :382
...
// private void DetachRequest() [instance] :330
void Http__FuseJSHttpRequest::DetachRequest()
{
    ...
    uPtr(_req)->remove_Aborted(uDelegate::New(::TYPES[8/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/], (void*)Http__FuseJSHttpRequest__OnAbort_fn, this));
    uPtr(_req)->remove_Error(uDelegate::New(::TYPES[9/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, string>*/], (void*)Http__FuseJSHttpRequest__OnError_fn, this));
    uPtr(_req)->remove_Timeout(uDelegate::New(::TYPES[8/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/], (void*)Http__FuseJSHttpRequest__OnTimeout_fn, this));
    uPtr(_req)->remove_Done(uDelegate::New(::TYPES[8/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/], (void*)Http__FuseJSHttpRequest__OnDone_fn, this));
    uPtr(_req)->remove_StateChanged(uDelegate::New(::TYPES[8/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/], (void*)Http__FuseJSHttpRequest__OnStateChanged_fn, this));
    uPtr(_req)->remove_Progress(uDelegate::New(::TYPES[10/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, int, int, bool>*/], (void*)Http__FuseJSHttpRequest__OnProgress_fn, this));
    uPtr(_req)->Dispose();
    _req = NULL;
    Obj(NULL);
}

// private object EnableCache(object[] args) [instance] :511
...
// private object GetResponseContentByteArray(object[] args) [instance] :428
...
// private string GetResponseContentString(object[] args) [instance] :413
...
// private string GetResponseHeader(string key) [instance] :398
...
// private string GetResponseHeaders() [instance] :388
...
// private object GetResponseReasonPhrase(object[] args) [instance] :538
...
// private int GetResponseStatus() [instance] :528
...
// private object GetResponseType(object[] args) [instance] :556
uObject* Http__FuseJSHttpRequest::GetResponseType(uArray* args)
{
    if (_req == NULL)
        return uBox<int>(::TYPES[23/*int*/], _cachedResponseType);

    return uBox<int>(::TYPES[23/*int*/], uPtr(_req)->HttpResponseType());
}

// private object GetState(object[] args) [instance] :523
uObject* Http__FuseJSHttpRequest::GetState(uArray* args)
{
    return uBox<int>(::TYPES[23/*int*/], (_req != NULL) ? uPtr(_req)->State() : _finalState);
}

// public generated Fuse.Scripting.Object get_Obj() [instance] :290
::g::Fuse::Scripting::Object* Http__FuseJSHttpRequest::Obj()
{
    return _Obj;
}

// private generated void set_Obj(Fuse.Scripting.Object value) [instance] :290
void Http__FuseJSHttpRequest::Obj(::g::Fuse::Scripting::Object* value)
{
    _Obj = value;
}

// private void OnAbort(Uno.Net.Http.HttpMessageHandlerRequest res) [instance] :443
...
// private void OnDone(Uno.Net.Http.HttpMessageHandlerRequest res) [instance] :474
...
// private void OnError(Uno.Net.Http.HttpMessageHandlerRequest res, string error) [instance] :451
...
// private void OnProgress(Uno.Net.Http.HttpMessageHandlerRequest res, int current, int total, bool hastotal) [instance] :482
void Http__FuseJSHttpRequest::OnProgress(::g::Uno::Net::Http::HttpMessageHandlerRequest* res, int current, int total, bool hastotal)
{
    ...
    if (func != NULL)
        uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 3, uBox<int>(::TYPES[23/*int*/], current), uBox<int>(::TYPES[23/*int*/], total), uBox(::g::Uno::Bool_typeof(), hastotal)));
}

// private void OnStateChanged(Uno.Net.Http.HttpMessageHandlerRequest res) [instance] :467
void Http__FuseJSHttpRequest::OnStateChanged(::g::Uno::Net::Http::HttpMessageHandlerRequest* res)
{
    ...
    if (func != NULL)
        uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, uBox<int>(::TYPES[23/*int*/], uPtr(_req)->State())));
}

// private void OnTimeout(Uno.Net.Http.HttpMessageHandlerRequest res) [instance] :459
...
// private object SendAsync(object[] args) [instance] :489
uObject* Http__FuseJSHttpRequest::SendAsync(uArray* args)
{
    if (uPtr(args)->Length() > 0)
    {
        ...
        uArray* data2 = uAs<uArray*>(args->Strong<uObject*>(0), ::TYPES[22/*byte[]*/]);
...
// private void SetHeader(string key, string value) [instance] :370
...
// private object SetResponseType(object[] args) [instance] :543
uObject* Http__FuseJSHttpRequest::SetResponseType(uArray* args)
{
    ...
    if (uPtr(args)->Length() > 0)
    {
        ...
        int value = uIs(arg, ::TYPES[23/*int*/]) ? uUnbox<int>(::TYPES[23/*int*/], arg) : (int)uUnbox<double>(::g::Uno::Double_typeof(), arg);
...
// private void SetTimeout(int timeout) [instance] :376
...
// public FuseJSHttpRequest New(Fuse.Scripting.Context context, Uno.Net.Http.HttpMessageHandlerRequest req) [static] :301
...
// public sealed class Http :222
// {
static void Http_build(uType* type)
{
    ::STRINGS[32] = uString::Const("FuseJS/Http");
    ::STRINGS[33] = uString::Const("exports");
    ::TYPES[24] = ::g::Uno::Func2_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), uObject_typeof()->Array(), uObject_typeof(), NULL);
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Fuse::Scripting::NativeModule_type, interface0),
        ::g::Fuse::Scripting::IModuleProvider_typeof(), offsetof(::g::Fuse::Scripting::NativeModule_type, interface1));
    type->SetFields(4,
...
// private object CreateClient(Fuse.Scripting.Context context, object[] args) :236
...
// public override sealed void Evaluate(Fuse.Scripting.Context c, Fuse.Scripting.ModuleResult result) :231
void Http__Evaluate_fn(Http* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    uPtr(uPtr(result)->Object)->Item(::STRINGS[33/*"exports"*/], Http__FunctionClosure::New1(c, uDelegate::New(::TYPES[24/*Uno.Func<Fuse.Scripting.Context, object[], object>*/], (void*)Http__CreateClient_fn, __this))->Callback());
}
...
void Http::ctor_2()
{
    ...
    ::g::Uno::UX::Resource::SetGlobalKey(Http::_instance_ = this, ::STRINGS[32/*"FuseJS/Http"*/]);
}

// private object CreateClient(Fuse.Scripting.Context context, object[] args) [instance] :236
uObject* Http::CreateClient(::g::Fuse::Scripting::Context* context, uArray* args)
{
    return Http__FuseJSHttpClient::New1(context)->Obj();
}

// public Http New() [static] :225
Http* Http::New2()
{
...
// internal sealed class HttpHeaders :567
// {
static void HttpHeaders_build(uType* type)
{
    ::STRINGS[34] = uString::Const(", ");
    ::STRINGS[35] = uString::Const("");
    ::TYPES[25] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::String_typeof(), NULL), NULL);
    ::TYPES[26] = ::g::Uno::IDisposable_typeof();
    ::TYPES[27] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(7/*ToArray<string>*/, ::g::Uno::String_typeof(), NULL);
    ::TYPES[28] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[29] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[30] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[31] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    type->SetFields(0,
        ::TYPES[25/*Uno.Collections.Dictionary<string, Uno.Collections.IList<string>>*/], offsetof(::g::Fuse::Reactive::FuseJS::HttpHeaders, _headers), 0);
}
...
// public string GetValue(string key) [instance] :584
uString* HttpHeaders::GetValue(uString* key)
{
    ...
    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(_headers), ::g::Uno::String::ToLower(uPtr(key)), (void**)(&list), &ret6), ret6))
        return ::g::Uno::String::Join(::STRINGS[34/*", "*/], (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[27/*Uno.Collections.EnumerableExtensions.ToArray<string>*/], list));

    return ::STRINGS[35/*""*/];
}

// private void ParseHeader(string headerLine) [instance] :594
void HttpHeaders::ParseHeader(uString* headerLine)
{
    ...
    uArray* strings = ::g::Uno::String::Split(uPtr(::g::Uno::String::Trim(uPtr(::g::Uno::String::Substring1(headerLine, colon + 1, headerLine->Length() - (colon + 1))))), uArray::Init<int>(::TYPES[28/*char[]*/], 1, ';'));
    ::g::Uno::Collections::List* values = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[29/*Uno.Collections.List<string>*/]);
    ...
    if ((::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(_headers), name, &ret7), ret7))
        ...
        for (::g::Uno::Collections::List__Enumerator<uStrong<uString*> > enum4 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(values), &ret8), ret8); enum4.MoveNext(::TYPES[30/*Uno.Collections.List<string>.Enumerator*/]); )
        {
            uString* value = enum4.Current(::TYPES[30/*Uno.Collections.List<string>.Enumerator*/]);
            ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr((::g::Uno::Collections::Dictionary__get_Item_fn(uPtr(_headers), name, &ret9), ret9)), ::TYPES[31/*Uno.Collections.ICollection<string>*/]), value);
        }
    else
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(_headers), name, (uObject*)values);
}

// internal HttpHeaders New(string headers) [static] :571
...
{
    ::STRINGS[36] = uString::Const("receivedUri");
    ::STRINGS[37] = uString::Const("FuseJS/InterApp");
    ::STRINGS[38] = uString::Const("onReceivedUri");
    ::STRINGS[39] = uString::Const("launchUri");
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[5] = ::g::Fuse::Scripting::NativeCallback_typeof();
    ::TYPES[32] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[6] = ::g::Uno::String_typeof();
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Fuse::Scripting::NativeModule_type, interface0),
        ::g::Fuse::Scripting::IModuleProvider_typeof(), offsetof(::g::Fuse::Scripting::NativeModule_type, interface1));
...
// public static object LaunchUri(Fuse.Scripting.Context context, object[] args) :416
...
// public InterApp New() :378
void InterApp__New3_fn(InterApp** __retval)
{
    *__retval = InterApp::New3();
}

// private void OnReceivedUri(string uri) :403
...
// public InterApp() [instance] :378
void InterApp::ctor_3()
{
    ctor_2(true, uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, ::STRINGS[36/*"receivedUri"*/]));

    if (InterApp::_instance_ != NULL)
        return;

    ::g::Uno::UX::Resource::SetGlobalKey(InterApp::_instance_ = this, ::STRINGS[37/*"FuseJS/Inte...*/]);
    ::g::Fuse::Scripting::NativeEvent* onReceivedUri = ::g::Fuse::Scripting::NativeEvent::New4(::STRINGS[38/*"onReceivedUri"*/], true);
    On1(::STRINGS[36/*"receivedUri"*/], onReceivedUri);
    AddMember(onReceivedUri);
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[39/*"launchUri"*/], uDelegate::New(::TYPES[5/*Fuse.Scripting.NativeCallback*/], (void*)InterApp__LaunchUri_fn)));
    ::g::Fuse::Platform::InterApp::add_ReceivedURI(uDelegate::New(::TYPES[32/*Uno.Action<string>*/], (void*)InterApp__OnReceivedUri_fn, this));
}

// private void OnReceivedUri(string uri) [instance] :403
void InterApp::OnReceivedUri(uString* uri)
{
    Emit(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, ::STRINGS[36/*"receivedUri"*/], uri));
}

// public static object LaunchUri(Fuse.Scripting.Context context, object[] args) [static] :416
uObject* InterApp::LaunchUri(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ::g::Fuse::Launcher::LaunchUri(::g::Uno::Net::Http::Uri::New1(uCast<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[6/*string*/])));
    return NULL;
}

// public InterApp New() [static] :378
...
{
    ::STRINGS[40] = uString::Const("FuseJS/Maps");
    ::STRINGS[41] = uString::Const("openAt");
    ::STRINGS[42] = uString::Const("searchNearby");
    ::STRINGS[43] = uString::Const("searchNear");
    ::TYPES[5] = ::g::Fuse::Scripting::NativeCallback_typeof();
    ::TYPES[6] = ::g::Uno::String_typeof();
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Fuse::Scripting::NativeModule_type, interface0),
...
// public static object OpenAt(Fuse.Scripting.Context context, object[] args) :572
void Maps__OpenAt_fn(::g::Fuse::Scripting::Context* context, uArray* args, uObject** __retval)
{
    *__retval = Maps::OpenAt(context, args);
}

// public static object SearchNear(Fuse.Scripting.Context context, object[] args) :551
...
// public static object SearchNearby(Fuse.Scripting.Context context, object[] args) :530
...
void Maps::ctor_2()
{
    ...
    ::g::Uno::UX::Resource::SetGlobalKey(Maps::_instance_ = this, ::STRINGS[40/*"FuseJS/Maps"*/]);
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[41/*"openAt"*/], uDelegate::New(::TYPES[5/*Fuse.Scripting.NativeCallback*/], (void*)Maps__OpenAt_fn)));
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[42/*"searchNearby"*/], uDelegate::New(::TYPES[5/*Fuse.Scripting.NativeCallback*/], (void*)Maps__SearchNearby_fn)));
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[43/*"searchNear"*/], uDelegate::New(::TYPES[5/*Fuse.Scripting.NativeCallback*/], (void*)Maps__SearchNear_fn)));
}

// public Maps New() [static] :510
Maps* Maps::New2()
{
...
// public static object OpenAt(Fuse.Scripting.Context context, object[] args) [static] :572
uObject* Maps::OpenAt(::g::Fuse::Scripting::Context* context, uArray* args)
{
    double latitude = ::g::Fuse::Scripting::Marshal::ToDouble(uPtr(args)->Strong<uObject*>(0));
    double longitude = ::g::Fuse::Scripting::Marshal::ToDouble(args->Strong<uObject*>(1));
    ::g::Fuse::Launcher::LaunchMaps(latitude, longitude);
    return NULL;
}

// public static object SearchNear(Fuse.Scripting.Context context, object[] args) [static] :551
uObject* Maps::SearchNear(::g::Fuse::Scripting::Context* context, uArray* args)
{
    double latitude = ::g::Fuse::Scripting::Marshal::ToDouble(uPtr(args)->Strong<uObject*>(0));
    double longitude = ::g::Fuse::Scripting::Marshal::ToDouble(args->Strong<uObject*>(1));
    uString* query = uCast<uString*>(args->Strong<uObject*>(2), ::TYPES[6/*string*/]);
    ::g::Fuse::Launcher::LaunchMaps1(latitude, longitude, query);
    return NULL;
}

// public static object SearchNearby(Fuse.Scripting.Context context, object[] args) [static] :530
uObject* Maps::SearchNearby(::g::Fuse::Scripting::Context* context, uArray* args)
{
    uString* query = uCast<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[6/*string*/]);
...
// public sealed class Phone :452
// {
static void Phone_build(uType* type)
{
    ::STRINGS[44] = uString::Const("FuseJS/Phone");
...
// public Phone() [instance] :455
void Phone::ctor_2()
{
    ctor_1();
    ::g::Uno::UX::Resource::SetGlobalKey(Phone::_instance_ = this, ::STRINGS[44/*"FuseJS/Phone"*/]);
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[45/*"call"*/], uDelegate::New(::TYPES[5/*Fuse.Scripting.NativeCallback*/], (void*)Phone__Call_fn)));
}

// public static object Call(Fuse.Scripting.Context context, object[] args) [static] :473
uObject* Phone::Call(::g::Fuse::Scripting::Context* context, uArray* args)
{
    uString* callString = uCast<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[6/*string*/]);
    ::g::Fuse::Launcher::LaunchCall(callString);
    return NULL;
}

// public Phone New() [static] :455
Phone* Phone::New2()
{
...
// private sealed class TimerManager.Timer :860
// {
...
// public Timer(double ms, Uno.Action callback, bool repeat) :875
...
// public Timer(double ms, Uno.Action callback, bool repeat) [instance] :875
...
// private void Start() [instance] :884
...
// internal void Update() [instance] :897
...
// public static double GetMilliseconds() [static] :920
double TimerManager__Timer::GetMilliseconds()
{
    return (double)(::g::Uno::Diagnostics::Clock::GetTicks() / 10000LL);
}

// public Timer New(double ms, Uno.Action callback, bool repeat) [static] :875
...
// internal sealed class TimerManager :785
// {
...
// public generated TimerManager() :785
void TimerManager__ctor__fn(TimerManager* __this)
{
    __this->ctor_();
}

// public int AddTimer(double ms, Uno.Action callback, [bool repeat]) :806
...
// public int AddTimer(double ms, Uno.Action callback, [bool repeat]) [instance] :806
int TimerManager::AddTimer(double ms, uDelegate* callback, bool repeat)
{
    ...
    t->OnStop = uDelegate::New(::TYPES[12/*Uno.Action<int>*/], (void*)TimerManager__RemoveTimer_fn, this);
    ::g::Uno::Collections::List__Add_fn(uPtr(_timers), t);
    return t->ID;
}

// public void DeleteAllTimers() [instance] :814
...
// public bool DeleteTimer(int id) [instance] :822
...
// private Fuse.Reactive.FuseJS.TimerManager.Timer GetTimer(int id) [instance] :842
...
// private void RemoveTimer(int id) [instance] :833
...
// public generated TimerManager New() [static] :785
...
// public sealed class TimerModule :650
// {
static void TimerModule_build(uType* type)
{
    ::STRINGS[0] = uString::Const("FuseJS/Timer");
    ::STRINGS[46] = uString::Const("create");
    ::STRINGS[47] = uString::Const("delete");
    ::STRINGS[48] = uString::Const("create(): requires at least three arguments");
    ::STRINGS[49] = uString::Const("create(): first argument must be a function");
    ::STRINGS[50] = uString::Const("delete(): requires one argument");
    ::TYPES[5] = ::g::Fuse::Scripting::NativeCallback_typeof();
...
// public TimerModule() :667
void TimerModule__ctor_2_fn(TimerModule* __this)
{
    __this->ctor_2();
}

// private object Create(Fuse.Scripting.Context context, object[] args) :704
...
// private object Delete(Fuse.Scripting.Context context, object[] args) :745
...
// public TimerModule() [instance] :667
void TimerModule::ctor_2()
{
    ...
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[46/*"create"*/], uDelegate::New(::TYPES[5/*Fuse.Scripting.NativeCallback*/], (void*)TimerModule__Create_fn, this)));
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[47/*"delete"*/], uDelegate::New(::TYPES[5/*Fuse.Scripting.NativeCallback*/], (void*)TimerModule__Delete_fn, this)));
    add_Reset(uDelegate::New(::TYPES[34/*Uno.EventHandler*/], (void*)TimerModule__OnReset_fn, this));
}

// private object Create(Fuse.Scripting.Context context, object[] args) [instance] :704
uObject* TimerModule::Create(::g::Fuse::Scripting::Context* context, uArray* args)
{
    if (uPtr(args)->Length() < 3)
        U_THROW(::g::Fuse::Scripting::Error::New4(::STRINGS[48/*"create(): r...*/]));

    if (!uIs((uObject*)uPtr(args)->Strong<uObject*>(0), ::TYPES[2/*Fuse.Scripting.Function*/]))
        U_THROW(::g::Fuse::Scripting::Error::New4(::STRINGS[49/*"create(): f...*/]));
    ...
    return uBox<int>(::TYPES[23/*int*/], uPtr(_tm)->AddTimer(ms, uDelegate::New(::TYPES[13/*Uno.Action*/], (void*)TimerModule__CallbackClosure__Callback_fn, TimerModule__CallbackClosure::New1(context, func, innerArgs)), repeat));
}

// private object Delete(Fuse.Scripting.Context context, object[] args) [instance] :745
uObject* TimerModule::Delete(::g::Fuse::Scripting::Context* context, uArray* args)
{
    if (uPtr(args)->Length() < 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::STRINGS[50/*"delete(): r...*/]));

    uPtr(_tm)->DeleteTimer(::g::Fuse::Scripting::Marshal::ToInt(uPtr(args)->Strong<uObject*>(0)));
    return NULL;
}

// private void OnReset(object sender, Uno.EventArgs args) [instance] :680
...
// internal void UpdateModule() [instance] :755
...
// public TimerModule New() [static] :667
