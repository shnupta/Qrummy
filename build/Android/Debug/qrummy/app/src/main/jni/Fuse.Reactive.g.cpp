...
{
    ::STRINGS[12] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive/0.41.3/fusejs/$.uno");
...
uObject* Console::Dir(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(builder->ToString(), 1, ::STRINGS[12/*"/usr/local/...*/], 126);
    return NULL;
}
...
{
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[13/*"null"*/], 1, ::STRINGS[12/*"/usr/local/...*/], 112);
...
{
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[13/*"null"*/], 1, ::STRINGS[12/*"/usr/local/...*/], 90);
...
void JavaScript::EvaluateModule()
{
...

    {
        ...
        if (newModuleResult->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[36/*"JavaScript ...*/], FileName()), ::STRINGS[37/*" fixed!"*/]), this, ::STRINGS[10/*"/usr/local/...*/], 1585, ::STRINGS[38/*"EvaluateMod...*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserScriptError(::STRINGS[39/*"JavaScript ...*/], se, this, ::STRINGS[10/*"/usr/local/...*/], 1596, ::STRINGS[38/*"EvaluateMod...*/]);
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[46/*"Skipped Exc...*/], next, this, ::STRINGS[10/*"/usr/local/...*/], 2243, ::STRINGS[47/*"CheckAndThrow"*/]);
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[48/*"ThreadWorke...*/], e, this, ::STRINGS[10/*"/usr/local/...*/], 2128, ::STRINGS[49/*"Run"*/]);
