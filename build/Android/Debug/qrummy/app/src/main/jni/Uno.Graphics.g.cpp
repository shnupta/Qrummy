...
// /usr/local/share/uno/Packages/UnoCore/0.41.5/source/uno/graphics/$.uno
// ----------------------------------------------------------------------
...
// internal void ForceResetState() :387
...
// internal void ForceResetState() [instance] :387
...
void GraphicsContext::SetRenderTarget(::g::Uno::Graphics::RenderTarget* renderTarget)
{
    if (renderTarget == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[1/*"renderTarget"*/]));
...
{
    ::STRINGS[2] = uString::Const("Invalid IndexType <");
...
int IndexTypeHelpers::GetStrideInBytes(int type)
{
    switch (type)
    {
        ...
        case 4:
            return type;
        default:
            U_THROW(::g::Uno::FormatException::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[2/*"Invalid Ind...*/], uBox<int>(::g::Uno::Graphics::IndexType_typeof(), type)), ::STRINGS[3/*">"*/])));
    }
}
// }
...
{
    ::STRINGS[7] = uString::Const("Invalid VertexAttributeType <");
    ::STRINGS[3] = uString::Const(">");
}
...
int VertexAttributeTypeHelpers::GetStrideInBytes(int type)
{
    switch (type)
    {
        ...
        case 20:
            return 4;
        default:
            U_THROW(::g::Uno::FormatException::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[7/*"Invalid Ver...*/], uBox<int>(::g::Uno::Graphics::VertexAttributeType_typeof(), type)), ::STRINGS[3/*">"*/])));
    }
}
// }
