...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.41.5/uriparsers/$.uno
// ------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.41.5/$.uno
// -------------------------------------------------------
...
static void HttpMessageCache_build(uType* type)
{
    ...
    ::STRINGS[23] = uString::Const("/usr/local/share/uno/Packages/Uno.Net.Http/0.41.5/$.uno");
...
void HttpMessageCache::IsCacheEnabled(bool value)
{
    ...
    if (HttpMessageCache::_isInitialized())
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[22/*"Uno.Net.Htt...*/], 1, ::STRINGS[23/*"/usr/local/...*/], 17);
    else
...
{
    ::STRINGS[24] = uString::Const("handler");
    ::STRINGS[25] = uString::Const("method");
    ::STRINGS[26] = uString::Const("url");
    ::STRINGS[27] = uString::Const("dispatcher");
    ::STRINGS[28] = uString::Const("HttpMessageHandlerRequest");
    ::STRINGS[29] = uString::Const("");
    ::STRINGS[30] = uString::Const("GET");
    ::STRINGS[31] = uString::Const("HEAD");
    ::STRINGS[32] = uString::Const("Not allowed to set header \"");
    ::STRINGS[33] = uString::Const("\" on this target.");
    ...
    ::TYPES[11] = ::g::Uno::Net::Http::Implementation::AndroidHttpRequest_typeof();
    ::TYPES[12] = ::g::Uno::Action1_typeof()->MakeType(type, NULL);
    ::TYPES[13] = ::g::Uno::Action2_typeof()->MakeType(type, ::g::Uno::String_typeof(), NULL);
    ::TYPES[14] = ::g::Uno::Action4_typeof()->MakeType(type, ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Bool_typeof(), NULL);
    type->SetInterfaces(
    ...
    type->SetFields(0,
        ...
        ::TYPES[12/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/], offsetof(::g::Uno::Net::Http::HttpMessageHandlerRequest, Aborted1), 0,
        ::TYPES[12/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/], offsetof(::g::Uno::Net::Http::HttpMessageHandlerRequest, Done1), 0,
        ::TYPES[13/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, string>*/], offsetof(::g::Uno::Net::Http::HttpMessageHandlerRequest, Error1), 0,
        ::TYPES[14/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, int, int, bool>*/], offsetof(::g::Uno::Net::Http::HttpMessageHandlerRequest, Progress1), 0,
        ::TYPES[12/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/], offsetof(::g::Uno::Net::Http::HttpMessageHandlerRequest, StateChanged1), 0,
        ::TYPES[12/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/], offsetof(::g::Uno::Net::Http::HttpMessageHandlerRequest, Timeout1), 0);
}
...
{
    if (handler == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[24/*"handler"*/]));

    if (::g::Uno::String::op_Equality(method, NULL))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[25/*"method"*/]));

    if (::g::Uno::String::op_Equality(url, NULL))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[26/*"url"*/]));

    if (dispatcher == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[27/*"dispatcher"*/]));
...
{
    Aborted1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Aborted1, value), ::TYPES[12/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
{
    Aborted1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Aborted1, value), ::TYPES[12/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
void HttpMessageHandlerRequest::CheckDisposed()
{
    if (_httpRequest == NULL)
        U_THROW(::g::Uno::ObjectDisposedException::New4(::STRINGS[28/*"HttpMessage...*/]));
}
...
{
    Done1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Done1, value), ::TYPES[12/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
{
    Done1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Done1, value), ::TYPES[12/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
{
    Error1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Error1, value), ::TYPES[13/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, string>*/]);
}
...
{
    Error1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Error1, value), ::TYPES[13/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, string>*/]);
}
...
uString* HttpMessageHandlerRequest::GetResponseContentString()
{
    ...
    return (ind1 != NULL) ? ind1 : ::STRINGS[29/*""*/];
}
...
{
    ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(_dispatcher), ::TYPES[8/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[9/*Uno.Action*/], (void*)HttpMessageHandlerRequest__FireSetHeadersReceived_fn, this));
}
...
void HttpMessageHandlerRequest::OnProgress(int current, int total, bool hasTotal)
{
    ...
    if (::g::Uno::Delegate::op_Inequality(handler, NULL))
        ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(_dispatcher), ::TYPES[8/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[9/*Uno.Action*/], (void*)HttpMessageHandlerRequest__ProgressClosure__Run_fn, HttpMessageHandlerRequest__ProgressClosure::New1(4, handler, this, current, total, hasTotal)));
}
...
{
    Progress1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Progress1, value), ::TYPES[14/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, int, int, bool>*/]);
}
...
{
    Progress1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Progress1, value), ::TYPES[14/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest, int, int, bool>*/]);
}
...
void HttpMessageHandlerRequest::SendAsync1(uArray* data)
{
    ...
    if (((::g::Uno::String::op_Equality(Method(), ::STRINGS[30/*"GET"*/]) || ::g::Uno::String::op_Equality(Method(), ::STRINGS[31/*"HEAD"*/])) || (data == NULL)) || (uPtr(data)->Length() == 0))
        ::g::Uno::Net::Http::Implementation::IHttpRequest::SendAsync(uInterface(uPtr(_httpRequest), ::TYPES[5/*Uno.Net.Http.Implementation.IHttpRequest*/]));
    else
    {
...
void HttpMessageHandlerRequest::SendAsync2(uString* data)
{
    ...
    if (((::g::Uno::String::op_Equality(Method(), ::STRINGS[30/*"GET"*/]) || ::g::Uno::String::op_Equality(Method(), ::STRINGS[31/*"HEAD"*/])) || ::g::Uno::String::op_Equality(data, NULL)) || ::g::Uno::String::op_Equality(data, ::STRINGS[29/*""*/]))
        ::g::Uno::Net::Http::Implementation::IHttpRequest::SendAsync(uInterface(uPtr(_httpRequest), ::TYPES[5/*Uno.Net.Http.Implementation.IHttpRequest*/]));
    else
...
void HttpMessageHandlerRequest::SetHeader(uString* name, uString* value)
{
    ...
    if (!HttpMessageHandlerRequest::IsHeaderValid(name, value))
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[32/*"Not allowed...*/], name), ::STRINGS[33/*"\" on this ...*/])));
...
void HttpMessageHandlerRequest::SetResponseType(int responseType)
{
    ...
    uPtr(uAs< ::g::Uno::Net::Http::Implementation::AndroidHttpRequest*>(_httpRequest, ::TYPES[11/*Uno.Net.Http.Implementation.AndroidHttpRequest*/]))->SetResponseType1(responseType);
}
...
{
    StateChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(StateChanged1, value), ::TYPES[12/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
{
    StateChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(StateChanged1, value), ::TYPES[12/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
{
    Timeout1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Timeout1, value), ::TYPES[12/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
{
    Timeout1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Timeout1, value), ::TYPES[12/*Uno.Action<Uno.Net.Http.HttpMessageHandlerRequest>*/]);
}
...
static void HttpStatusReasonPhrase__cctor__fn(uType* __type)
{
    ...
    HttpStatusReasonPhrase::Informational_ = (uObject*)(collection5 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[15/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection5), uCRef<int>(100), ::STRINGS[34/*"Continue"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection5), uCRef<int>(101), ::STRINGS[35/*"Switching P...*/]), collection5);
    HttpStatusReasonPhrase::Success_ = (uObject*)(collection4 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[15/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(200), ::STRINGS[36/*"OK"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(201), ::STRINGS[37/*"Created"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(202), ::STRINGS[38/*"Accepted"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(203), ::STRINGS[39/*"Non-Authori...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(204), ::STRINGS[40/*"No Content"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(205), ::STRINGS[41/*"Reset Content"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(206), ::STRINGS[42/*"Partial Con...*/]), collection4);
    HttpStatusReasonPhrase::Redirection_ = (uObject*)(collection3 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[15/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(300), ::STRINGS[43/*"Multiple Ch...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(301), ::STRINGS[44/*"Moved Perma...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(302), ::STRINGS[45/*"Found"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(303), ::STRINGS[46/*"See Other"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(304), ::STRINGS[47/*"Not Modified"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(305), ::STRINGS[48/*"Use Proxy"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(307), ::STRINGS[49/*"Temporary R...*/]), collection3);
    HttpStatusReasonPhrase::ClientErrors_ = (uObject*)(collection2 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[15/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(400), ::STRINGS[50/*"Bad Request"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(401), ::STRINGS[51/*"Unauthorized"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(402), ::STRINGS[52/*"Payment Req...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(403), ::STRINGS[53/*"Forbidden"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(404), ::STRINGS[54/*"Not Found"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(405), ::STRINGS[55/*"Method Not ...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(406), ::STRINGS[56/*"Not Accepta...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(407), ::STRINGS[57/*"Proxy Authe...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(408), ::STRINGS[58/*"Request Tim...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(409), ::STRINGS[59/*"Conflict"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(410), ::STRINGS[60/*"Gone"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(411), ::STRINGS[61/*"Length Requ...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(412), ::STRINGS[62/*"Preconditio...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(413), ::STRINGS[63/*"Request Ent...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(414), ::STRINGS[64/*"Request-URI...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(415), ::STRINGS[65/*"Unsupported...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(416), ::STRINGS[66/*"Requested r...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(417), ::STRINGS[67/*"Expectation...*/]), collection2);
    HttpStatusReasonPhrase::ServerErrors_ = (uObject*)(collection1 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[15/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(500), ::STRINGS[68/*"Internal Se...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(501), ::STRINGS[69/*"Not Impleme...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(502), ::STRINGS[70/*"Bad Gateway"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(503), ::STRINGS[71/*"Service Una...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(504), ::STRINGS[72/*"Gateway Tim...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(505), ::STRINGS[73/*"HTTP Versio...*/]), collection1);
}

static void HttpStatusReasonPhrase_build(uType* type)
{
    ::STRINGS[34] = uString::Const("Continue");
    ::STRINGS[35] = uString::Const("Switching Protocols");
    ::STRINGS[36] = uString::Const("OK");
    ::STRINGS[37] = uString::Const("Created");
    ::STRINGS[38] = uString::Const("Accepted");
    ::STRINGS[39] = uString::Const("Non-Authoritative Information");
    ::STRINGS[40] = uString::Const("No Content");
    ::STRINGS[41] = uString::Const("Reset Content");
    ::STRINGS[42] = uString::Const("Partial Content");
    ::STRINGS[43] = uString::Const("Multiple Choices");
    ::STRINGS[44] = uString::Const("Moved Permanently");
    ::STRINGS[45] = uString::Const("Found");
    ::STRINGS[46] = uString::Const("See Other");
    ::STRINGS[47] = uString::Const("Not Modified");
    ::STRINGS[48] = uString::Const("Use Proxy");
    ::STRINGS[49] = uString::Const("Temporary Redirect");
    ::STRINGS[50] = uString::Const("Bad Request");
    ::STRINGS[51] = uString::Const("Unauthorized");
    ::STRINGS[52] = uString::Const("Payment Required");
    ::STRINGS[53] = uString::Const("Forbidden");
    ::STRINGS[54] = uString::Const("Not Found");
    ::STRINGS[55] = uString::Const("Method Not Allowed");
    ::STRINGS[56] = uString::Const("Not Acceptable");
    ::STRINGS[57] = uString::Const("Proxy Authentication Required");
    ::STRINGS[58] = uString::Const("Request Time-out");
    ::STRINGS[59] = uString::Const("Conflict");
    ::STRINGS[60] = uString::Const("Gone");
    ::STRINGS[61] = uString::Const("Length Required");
    ::STRINGS[62] = uString::Const("Precondition Failed");
    ::STRINGS[63] = uString::Const("Request Entity Too Large");
    ::STRINGS[64] = uString::Const("Request-URI Too Large");
    ::STRINGS[65] = uString::Const("Unsupported Media Type");
    ::STRINGS[66] = uString::Const("Requested range not satisfiable");
    ::STRINGS[67] = uString::Const("Expectation Failed");
    ::STRINGS[68] = uString::Const("Internal Server Error");
    ::STRINGS[69] = uString::Const("Not Implemented");
    ::STRINGS[70] = uString::Const("Bad Gateway");
    ::STRINGS[71] = uString::Const("Service Unavailable");
    ::STRINGS[72] = uString::Const("Gateway Time-out");
    ::STRINGS[73] = uString::Const("HTTP Version not supported");
    ::TYPES[15] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::String_typeof(), NULL);
    ::TYPES[16] = ::g::Uno::Collections::IDictionary_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::String_typeof(), NULL);
    type->SetFields(0,
        ::TYPES[16/*Uno.Collections.IDictionary<int, string>*/], (uintptr_t)&::g::Uno::Net::Http::HttpStatusReasonPhrase::ClientErrors_, uFieldFlagsStatic,
        ::TYPES[16/*Uno.Collections.IDictionary<int, string>*/], (uintptr_t)&::g::Uno::Net::Http::HttpStatusReasonPhrase::Informational_, uFieldFlagsStatic,
        ::TYPES[16/*Uno.Collections.IDictionary<int, string>*/], (uintptr_t)&::g::Uno::Net::Http::HttpStatusReasonPhrase::Redirection_, uFieldFlagsStatic,
        ::TYPES[16/*Uno.Collections.IDictionary<int, string>*/], (uintptr_t)&::g::Uno::Net::Http::HttpStatusReasonPhrase::ServerErrors_, uFieldFlagsStatic,
        ::TYPES[16/*Uno.Collections.IDictionary<int, string>*/], (uintptr_t)&::g::Uno::Net::Http::HttpStatusReasonPhrase::Success_, uFieldFlagsStatic);
}
...
uString* HttpStatusReasonPhrase::GetFromStatusCode(int statusCode)
{
    ...
    if ((::g::Uno::Collections::IDictionary::TryGetValue_ex(uInterface(uPtr(HttpStatusReasonPhrase::Informational()), ::TYPES[16/*Uno.Collections.IDictionary<int, string>*/]), uCRef<int>(statusCode), (void**)(&description), &ret6), ret6))
        return description;

    if ((::g::Uno::Collections::IDictionary::TryGetValue_ex(uInterface(uPtr(HttpStatusReasonPhrase::Success()), ::TYPES[16/*Uno.Collections.IDictionary<int, string>*/]), uCRef<int>(statusCode), (void**)(&description), &ret7), ret7))
        return description;

    if ((::g::Uno::Collections::IDictionary::TryGetValue_ex(uInterface(uPtr(HttpStatusReasonPhrase::Redirection()), ::TYPES[16/*Uno.Collections.IDictionary<int, string>*/]), uCRef<int>(statusCode), (void**)(&description), &ret8), ret8))
        return description;

    if ((::g::Uno::Collections::IDictionary::TryGetValue_ex(uInterface(uPtr(HttpStatusReasonPhrase::ClientErrors()), ::TYPES[16/*Uno.Collections.IDictionary<int, string>*/]), uCRef<int>(statusCode), (void**)(&description), &ret9), ret9))
        return description;

    if ((::g::Uno::Collections::IDictionary::TryGetValue_ex(uInterface(uPtr(HttpStatusReasonPhrase::ServerErrors()), ::TYPES[16/*Uno.Collections.IDictionary<int, string>*/]), uCRef<int>(statusCode), (void**)(&description), &ret10), ret10))
        return description;
...
{
    ::STRINGS[74] = uString::Const("Response type is invalid.");
    type->SetFields(3);
}
...
{
    ::STRINGS[75] = uString::Const("The object is in an invalid state.");
    type->SetFields(3);
}
...
{
    ::STRINGS[9] = uString::Const(":");
    ::STRINGS[76] = uString::Const("The scheme isn't specified in uriString.");
    ::STRINGS[77] = uString::Const("The scheme specified in uriString is not correctly formed.");
    ::STRINGS[78] = uString::Const("The length of the scheme specified in uriString exceeds 1023 characters.");
    ::STRINGS[20] = uString::Const("There is an invalid character sequence in uriString.");
}
...
::g::Uno::Net::Http::SchemeParserResult SchemeParser::Parse(uString* uriString, int* idx)
{
    ...
    if (end < 0)
        U_THROW(::g::Uno::Net::Http::UriFormatException::New4(::STRINGS[76/*"The scheme ...*/]));

    if (((*idx + 2) >= uriString->Length()) || (end == *idx))
        U_THROW(::g::Uno::Net::Http::UriFormatException::New4(::STRINGS[77/*"The scheme ...*/]));

    if ((end - *idx) > 1023)
        U_THROW(::g::Uno::Net::Http::UriFormatException::New4(::STRINGS[78/*"The length ...*/]));
...
// public sealed class Uri :868
// {
static void Uri_build(uType* type)
{
    ::STRINGS[79] = uString::Const("uriString");
    ::STRINGS[80] = uString::Const("The length of uriString exceeds 65519 characters.");
    ::STRINGS[81] = uString::Const("file");
    ::STRINGS[82] = uString::Const("Hostname part required in uriString for scheme ");
...
void Uri::CreateThis(uString* uriString)
{
    ...
    {
        if (::g::Uno::String::op_Inequality(Scheme(), ::STRINGS[81/*"file"*/]))
            U_THROW(::g::Uno::Net::Http::UriFormatException::New4(::g::Uno::String::op_Addition2(::STRINGS[82/*"Hostname pa...*/], Scheme())));
    }
}

// public generated string get_Hash() [instance] :886
uString* Uri::Hash()
{
    return _Hash;
}

// private generated void set_Hash(string value) [instance] :886
void Uri::Hash(uString* value)
{
    _Hash = value;
}

// public generated string get_Host() [instance] :876
uString* Uri::Host()
{
    return _Host;
}

// private generated void set_Host(string value) [instance] :876
void Uri::Host(uString* value)
{
    _Host = value;
}

// public generated string get_OriginalString() [instance] :878
uString* Uri::OriginalString()
{
    return _OriginalString;
}

// private generated void set_OriginalString(string value) [instance] :878
void Uri::OriginalString(uString* value)
{
    _OriginalString = value;
}

// public generated string get_PathAndQuery() [instance] :880
uString* Uri::PathAndQuery()
{
    return _PathAndQuery;
}

// private generated void set_PathAndQuery(string value) [instance] :880
void Uri::PathAndQuery(uString* value)
{
    _PathAndQuery = value;
}

// public generated int get_Port() [instance] :882
int Uri::Port()
{
    return _Port;
}

// private generated void set_Port(int value) [instance] :882
void Uri::Port(int value)
{
    _Port = value;
}

// public generated string get_Query() [instance] :884
uString* Uri::Query()
{
    return _Query;
}

// private generated void set_Query(string value) [instance] :884
void Uri::Query(uString* value)
{
    _Query = value;
}

// public generated string get_Scheme() [instance] :888
uString* Uri::Scheme()
{
    return _Scheme;
}

// private generated void set_Scheme(string value) [instance] :888
void Uri::Scheme(uString* value)
{
    _Scheme = value;
}

// public generated string get_UserInfo() [instance] :890
uString* Uri::UserInfo()
{
    return _UserInfo;
}

// private generated void set_UserInfo(string value) [instance] :890
void Uri::UserInfo(uString* value)
{
    _UserInfo = value;
}

// public static string Encode(string value) [static] :985
uString* Uri::Encode(uString* value)
{
    ...
    uArray* result = uArray::New(::TYPES[17/*char[]*/], count);
    int index = 0;
...
// private static bool EscapeSymbol(byte symbol) [static] :1063
...
// private static char GetHexFromNumber(int value) [static] :1044
...
// public Uri New(string uriString) [static] :892
...
static void UriScheme__cctor__fn(uType* __type)
{
    ...
    ::g::Uno::Collections::List* collection1;
    UriScheme::KnownInternetSchemes_ = (collection2 = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[0/*Uno.Collections.List<string>*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[83/*"http"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[84/*"https"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[85/*"ftp"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[86/*"gopher"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[87/*"nntp"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[88/*"telnet"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[89/*"wais"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[81/*"file"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[90/*"prospero"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[91/*"ws"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[92/*"wss"*/]), collection2);
    UriScheme::KnownNonInternetSchemes_ = (collection1 = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[0/*Uno.Collections.List<string>*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[93/*"mailto"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[94/*"news"*/]), collection1);
}

static void UriScheme_build(uType* type)
{
    ::STRINGS[83] = uString::Const("http");
    ::STRINGS[84] = uString::Const("https");
    ::STRINGS[85] = uString::Const("ftp");
    ::STRINGS[86] = uString::Const("gopher");
    ::STRINGS[87] = uString::Const("nntp");
    ::STRINGS[88] = uString::Const("telnet");
    ::STRINGS[89] = uString::Const("wais");
    ::STRINGS[81] = uString::Const("file");
    ::STRINGS[90] = uString::Const("prospero");
    ::STRINGS[91] = uString::Const("ws");
    ::STRINGS[92] = uString::Const("wss");
    ::STRINGS[93] = uString::Const("mailto");
    ::STRINGS[94] = uString::Const("news");
    ::TYPES[0] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[18] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Int_typeof(), NULL);
    type->SetFields(0,
        ::TYPES[18/*Uno.Collections.Dictionary<string, int>*/], (uintptr_t)&::g::Uno::Net::Http::UriScheme::_defaultPorts_, uFieldFlagsStatic,
...
bool UriScheme::IsHttpScheme(uString* scheme)
{
    UriScheme_typeof()->Init();
    uString* s = ::g::Uno::String::ToLower(uPtr(scheme));
    return ::g::Uno::String::op_Equality(s, ::STRINGS[83/*"http"*/]) || ::g::Uno::String::op_Equality(s, ::STRINGS[84/*"https"*/]);
}
...
::g::Uno::Collections::Dictionary* UriScheme::DefaultPorts()
{
    ...
    {
        UriScheme::_defaultPorts() = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[18/*Uno.Collections.Dictionary<string, int>*/]));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[83/*"http"*/], uCRef<int>(80));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[84/*"https"*/], uCRef<int>(443));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[85/*"ftp"*/], uCRef<int>(21));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[86/*"gopher"*/], uCRef<int>(70));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[88/*"telnet"*/], uCRef<int>(119));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[89/*"wais"*/], uCRef<int>(-1));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[81/*"file"*/], uCRef<int>(-1));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[90/*"prospero"*/], uCRef<int>(-1));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[93/*"mailto"*/], uCRef<int>(25));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[94/*"news"*/], uCRef<int>(-1));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[91/*"ws"*/], uCRef<int>(80));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[92/*"wss"*/], uCRef<int>(443));
    }
...
static void UserInfoParser_build(uType* type)
{
    ...
    ::STRINGS[96] = uString::Const("The user name or password specified in uriString is not valid.");
}
...
uString* UserInfoParser::Parse(uString* uriString, int endIdx, int* idx)
{
    ...
    int end = ::g::Uno::String::IndexOf1(uPtr(uriString), ::STRINGS[95/*"@"*/], *idx);
    ...
    if (!UserInfoParser::IsValid(userInfo))
        U_THROW(::g::Uno::Net::Http::UriFormatException::New4(::STRINGS[96/*"The user na...*/]));
