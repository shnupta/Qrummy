// This file was generated based on /usr/local/share/uno/Packages/UnoCore/0.41.5/backends/cplusplus/Uno/_main.cpp.
...
namespace g{namespace Fuse{namespace Internal{uStructType* MiniList_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{struct NativeModule_type;}} ::g::Fuse::Scripting::NativeModule_type* Qreader_typeof();}
...
namespace g{namespace Uno{namespace Permissions{namespace Internal{uType* Android_typeof();}}}}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::Uno::Permissions::Internal::Android_typeof,
