// This file was generated based on /usr/local/share/uno/Packages/Fuse.Controls/0.41.3/$.uno.
...
void Control__get_iOSTemplate_fn(Control* __this, ::g::Uno::UX::Template** __retval);
...
struct Control : ::g::Fuse::Elements::Element
{
    ...
    ::g::Uno::UX::Template* iOSTemplate();
    uObject* NativeParent();
