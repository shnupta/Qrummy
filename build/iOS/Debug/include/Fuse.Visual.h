...
struct Visual_type : ::g::Fuse::Node_type
{
    ...
    void(*fp_CalcIsLocalFlat)(::g::Fuse::Visual*, bool*);
    ...
    void(*fp_get_HitTestBounds)(::g::Fuse::Visual*, ::g::Fuse::VisualBounds**);
...
struct Visual : ::g::Fuse::Node
{
    ...
    double _drawCost;
    static uSStrong<uObject*> _emptyChildren_;
    static uSStrong<uObject*>& _emptyChildren() { return Visual_typeof()->Init(), _emptyChildren_; }
    ...
    bool CalcIsLocalFlat() { bool __retval; return (((Visual_type*)__type)->fp_CalcIsLocalFlat)(this, &__retval), __retval; }
    ...
    ::g::Fuse::VisualBounds* HitTestBounds() { ::g::Fuse::VisualBounds* __retval; return (((Visual_type*)__type)->fp_get_HitTestBounds)(this, &__retval), __retval; }
    ...
    void InsertImpl(int index, ::g::Fuse::Node* item);
    ...
    void MakeNodeList(::g::Fuse::Node* newItem);
    ::g::Uno::Float2 MarginBoxPosition();
    ::g::Fuse::Node* Node();
    ::g::Uno::Collections::List* NodeList();
    ...
    void OnSubtreeDataContextChanged();
    ...
    static bool CalcIsLocalFlat(Visual* __this) { bool __retval; return Visual__CalcIsLocalFlat_fn(__this, &__retval), __retval; }
    ...
    static ::g::Fuse::VisualBounds* HitTestBounds(Visual* __this) { ::g::Fuse::VisualBounds* __retval; return Visual__get_HitTestBounds_fn(__this, &__retval), __retval; }
