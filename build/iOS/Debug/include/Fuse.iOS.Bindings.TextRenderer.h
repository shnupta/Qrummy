...
struct TextRenderer : uObject
{
    ...
    static ::CGColorSpaceRef& _colorSpace() { return TextRenderer_typeof()->Init(), _colorSpace_; }
    ...
    static void DrawGlyphs(::CGContextRef context, float x, float y, int width, int height, uObject* layoutManager, uObject* textContainer);
