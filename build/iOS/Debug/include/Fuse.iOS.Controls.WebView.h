// This file was generated based on /usr/local/share/uno/Packages/Fuse.Controls.WebView/0.41.3/ios/$.uno.
...
struct WebView : ::g::Fuse::Controls::Native::iOS::LeafView
{
    ...
    uStrong<uObject*> Handle1;
    uStrong<uObject*> NavigationDelegate;
    ...
    void ctor_2(::g::Fuse::Controls::WebView* webViewHost, uObject* wvHandle);
    uString* BaseUrl();
    ...
    static WebView* New1(::g::Fuse::Controls::WebView* webViewHost, uObject* wvHandle);
};
// }
