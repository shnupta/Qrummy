// This file was generated based on /usr/local/share/uno/Packages/UnoCore/0.41.5/source/uno/collections/$.uno.
...
struct List : uObject
{
    ...
    template<class T>
    int IndexOf(T item) { int __retval; return List__IndexOf_fn(this, uConstrain(__type->T(0), item), &__retval), __retval; }
    template<class T>
