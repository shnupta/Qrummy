...
namespace g{struct FuseControlsScrollView_FuseControlsScrollViewBase_UserScroll_Property;}
...
struct FuseControlsScrollView_FuseControlsScrollViewBase_UserScroll_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Controls::ScrollViewBase*> _obj;

    void ctor_2(::g::Fuse::Controls::ScrollViewBase* obj, ::g::Uno::UX::Selector name);
    static FuseControlsScrollView_FuseControlsScrollViewBase_UserScroll_Property* New1(::g::Fuse::Controls::ScrollViewBase* obj, ::g::Uno::UX::Selector name);
};
// }
