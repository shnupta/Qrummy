...
// internal sealed extern class Rectangle :1718
// {
...
// public Rectangle(Fuse.Visual visual) :1721
void Rectangle__ctor_2_fn(Rectangle* __this, ::g::Fuse::Visual* visual)
{
    __this->ctor_2(visual);
}

// private void AddArcWithCenter(ObjC.Object handle, float centerX, float centerY, float radius, float startAngle, float endAngle) :1807
...
// private static ObjC.Object CreateUIBezierPath() :1780
void Rectangle__CreateUIBezierPath_fn(uObject** __retval)
{
    *__retval = Rectangle::CreateUIBezierPath();
}

// private void Fuse.Controls.Native.IRectangleView.set_CornerRadius(float4 value) :1729
...
// private void AddArcWithCenter(ObjC.Object handle, float centerX, float centerY, float radius, float startAngle, float endAngle) [instance] :1807
...
// private void AddLineToPoint(ObjC.Object handle, float x, float y) [instance] :1800
...
// private void ClosePath(ObjC.Object handle) [instance] :1786
...
// private void MoveToPoint(ObjC.Object handle, float x, float y) [instance] :1793
...
// private static ObjC.Object CreateUIBezierPath() [static] :1780
...
// public Rectangle New(Fuse.Visual visual) [static] :1721
