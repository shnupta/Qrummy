...
// /usr/local/share/uno/Packages/Fuse.Effects/0.41.3/$.uno
// -------------------------------------------------------
...
// private sealed class DropShadow.Blitter :365
// {
...
// public generated Blitter() :365
void DropShadow__Blitter__ctor__fn(DropShadow__Blitter* __this)
{
    __this->ctor_();
}

// public void Blit(Fuse.DrawContext dc, Fuse.Elements.Element element, Uno.Rect elementRect, float padding, int2 tempSize, texture2D blurTexture, float spreadScale, float2 offset, float4 color) :373
...
// public generated Blitter() [instance] :365
void DropShadow__Blitter::ctor_()
{
    init_DrawCalls();
}

// public void Blit(Fuse.DrawContext dc, Fuse.Elements.Element element, Uno.Rect elementRect, float padding, int2 tempSize, texture2D blurTexture, float spreadScale, float2 offset, float4 color) [instance] :373
...
// private generated void init_DrawCalls() [instance] :365
...
// public generated Blitter New() [static] :365
...
// public static Fuse.Effects.DropShadow.Blitter get_Instance() [static] :370
...
// public sealed class Desaturate :143
// {
...
// public float get_Amount() :156
void Desaturate__get_Amount_fn(Desaturate* __this, float* __retval)
{
    *__retval = __this->Amount();
}

// public void set_Amount(float value) :157
void Desaturate__set_Amount_fn(Desaturate* __this, float* value)
{
    __this->Amount(*value);
}

// protected override sealed void OnRender(Fuse.DrawContext dc, Uno.Rect elementRect) :167
...
// public float get_Amount() [instance] :156
float Desaturate::Amount()
{
    return _amount;
}

// public void set_Amount(float value) [instance] :157
...
// public sealed class DropShadow :205
// {
...
// private float2 get_Offset() :272
void DropShadow__get_Offset_fn(DropShadow* __this, ::g::Uno::Float2* __retval)
{
    *__retval = __this->Offset();
}

// protected override sealed void OnRender(Fuse.DrawContext dc, Uno.Rect elementRect) :341
...
// public float4 get_Color() [instance] :306
::g::Uno::Float4 DropShadow::Color()
{
    return _color;
}

// public void set_Color(float4 value) [instance] :310
...
// public float get_Distance() [instance] :254
float DropShadow::Distance()
{
    return _distance;
}

// public void set_Distance(float value) [instance] :255
...
// private float2 get_Offset() [instance] :272
...
// internal float get_Padding() [instance] :325
float DropShadow::Padding()
{
    return ::g::Uno::Math::Ceil1((Sigma() * 3.0f) * uPtr(Element())->AbsoluteZoom()) / uPtr(Element())->AbsoluteZoom();
}

// private float get_Radius() [instance] :228
float DropShadow::Radius()
{
    return Size() / 2.0f;
}

// internal float get_Sigma() [instance] :324
float DropShadow::Sigma()
{
    return ::g::Uno::Math::Max1(Radius(), 1e-05f);
}

// public float get_Size() [instance] :212
float DropShadow::Size()
{
    return _size;
}

// public void set_Size(float value) [instance] :213
...
// public float get_Spread() [instance] :284
float DropShadow::Spread()
{
    return _spread;
}

// public void set_Spread(float value) [instance] :285
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.41.3/effects/$.uno
// ----------------------------------------------------------------
...
// internal partial sealed class EffectHelpers :403
// {
...
// public generated EffectHelpers() :403
void EffectHelpers__ctor__fn(EffectHelpers* __this)
{
    __this->ctor_();
}

// public framebuffer Blur(texture2D original, Fuse.DrawContext dc, float sigma) :411
...
// private framebuffer BlurHorizontal(Fuse.DrawContext dc, int2 size, texture2D tex, float sigma, int samples) :550
...
// private framebuffer BlurVertical(Fuse.DrawContext dc, int2 size, texture2D tex, float sigma, int samples) :562
...
// private void GaussianBlurSeparable(texture2D tex, float2 dir, float sigma, int samples) :574
...
// private generated void init_DrawCalls() :403
void EffectHelpers__init_DrawCalls_fn(EffectHelpers* __this)
{
    __this->init_DrawCalls();
}

// public static Fuse.Effects.EffectHelpers get_Instance() :408
void EffectHelpers__get_Instance_fn(EffectHelpers** __retval)
{
    *__retval = EffectHelpers::Instance();
}

// public generated EffectHelpers New() :403
void EffectHelpers__New1_fn(EffectHelpers** __retval)
{
    *__retval = EffectHelpers::New1();
}

// private framebuffer ResampleGaussian5tap(Fuse.DrawContext dc, texture2D tex, int2 size) :461
...
// public generated EffectHelpers() [instance] :403
void EffectHelpers::ctor_()
{
    init_DrawCalls();
}

// public framebuffer Blur(texture2D original, Fuse.DrawContext dc, float sigma) [instance] :411
...
// private framebuffer BlurHorizontal(Fuse.DrawContext dc, int2 size, texture2D tex, float sigma, int samples) [instance] :550
...
// private framebuffer BlurVertical(Fuse.DrawContext dc, int2 size, texture2D tex, float sigma, int samples) [instance] :562
...
// private void GaussianBlurSeparable(texture2D tex, float2 dir, float sigma, int samples) [instance] :574
...
// private generated void init_DrawCalls() [instance] :403
...
// private framebuffer ResampleGaussian5tap(Fuse.DrawContext dc, texture2D tex, int2 size) [instance] :461
...
// public generated EffectHelpers New() [static] :403
...
// public static Fuse.Effects.EffectHelpers get_Instance() [static] :408
...
// public sealed class Halftone :637
// {
...
// public float get_Intensity() [instance] :662
float Halftone::Intensity()
{
    return _intensity;
}

// public void set_Intensity(float value) [instance] :663
...
// public float get_PaperTint() [instance] :707
float Halftone::PaperTint()
{
    return _paperTint;
}

// public void set_PaperTint(float value) [instance] :708
...
// public float get_Smoothness() [instance] :677
float Halftone::Smoothness()
{
    return _smoothness;
}

// public void set_Smoothness(float value) [instance] :678
...
// public float get_Spacing() [instance] :647
float Halftone::Spacing()
{
    return _spacing;
}

// public void set_Spacing(float value) [instance] :648
...
// private void Fuse.Internal.IImageContainerOwner.OnParamChanged() :800
void Mask__FuseInternalIImageContainerOwnerOnParamChanged_fn(Mask* __this)
{
    __this->OnRenderingChanged();
}

// private void Fuse.Internal.IImageContainerOwner.OnSizingChanged() :805
void Mask__FuseInternalIImageContainerOwnerOnSizingChanged_fn(Mask* __this)
{
    __this->OnRenderingChanged();
}

// private void Fuse.Internal.IImageContainerOwner.OnSourceChanged() :795
void Mask__FuseInternalIImageContainerOwnerOnSourceChanged_fn(Mask* __this)
{
    __this->OnRenderingChanged();
}

// public override sealed Fuse.VisualBounds ModifyRenderBounds(Fuse.VisualBounds inBounds) :836
...
// protected override sealed void OnRender(Fuse.DrawContext dc, Uno.Rect elementRect) :842
