...
static void GraphicsWorker_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.41.3/$.uno");
...
// private static extern ObjC.Object CreateContext() :2819
...
// private static extern void SetCurrentContext(ObjC.Object context) :2825
...
// private static extern ObjC.Object CreateContext() [static] :2819
    ...
    while (!GraphicsWorker::_terminating())
    {
        ...
        if ((::g::Uno::Threading::ConcurrentQueue__TryDequeue_fn(uPtr(GraphicsWorker::_work()), (void**)(&a), &ret2), ret2))
        {
            ...
            catch (const uThrowable& __t)
            {
                ...
                ::g::Fuse::Diagnostics::UnknownException(::STRINGS[1/*"GraphicsWor...*/], e, a, ::STRINGS[2/*"/usr/local/...*/], 2884, ::STRINGS[3/*"Run"*/]);
...
// private static extern void SetCurrentContext(ObjC.Object context) [static] :2825
