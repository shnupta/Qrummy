...
static void Builtins_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("fuse-builtins");
    ::STRINGS[3] = uString::Const("Promise = undefined;");
    ::STRINGS[4] = uString::Const("fuse-builtins: es6-promise");
...
void Builtins::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    uPtr(context)->Evaluate(::STRINGS[2/*"fuse-builtins"*/], ::STRINGS[3/*"Promise = u...*/]);
    context->Evaluate(::STRINGS[4/*"fuse-builti...*/], uPtr(::g::FuseReactive_bundle::es6promiseab78409a())->ReadAllText());
    Observable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseReactive_bundle::Observablebf595342()))->EvaluateExports(context, ::STRINGS[5/*"FuseJS/Obse...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
{
    ::STRINGS[9] = uString::Const("FuseJS/Email");
    ::STRINGS[10] = uString::Const("compose");
...
void Email::ctor_2()
{
    ...
    ::g::Uno::UX::Resource::SetGlobalKey(Email::_instance_ = this, ::STRINGS[9/*"FuseJS/Email"*/]);
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[10/*"compose"*/], uDelegate::New(::TYPES[5/*Fuse.Scripting.NativeCallback*/], (void*)Email__Compose_fn)));
}
...
void Http__FuseJSHttpClient::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    uPtr(Obj())->Item(::STRINGS[11/*"createRequest"*/], uDelegate::New(::TYPES[7/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpClient__CreateRequest_fn, this));
}
...
void Http__FuseJSHttpRequest::ctor_(::g::Fuse::Scripting::Context* context, ::g::Uno::Net::Http::HttpMessageHandlerRequest* req)
{
    ...
    uPtr(Obj())->Item(::STRINGS[12/*"enableCache"*/], uDelegate::New(::TYPES[7/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__EnableCache_fn, this));
    uPtr(Obj())->Item(::STRINGS[13/*"setTimeout"*/], ::g::Fuse::Scripting::JSCallback::FromAction1(::TYPES[11/*Fuse.Scripting.JSCallback.FromAction<int>*/], uDelegate::New(::TYPES[12/*Uno.Action<int>*/], (void*)Http__FuseJSHttpRequest__SetTimeout_fn, this)));
    uPtr(Obj())->Item(::STRINGS[14/*"setResponse...*/], uDelegate::New(::TYPES[7/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__SetResponseType_fn, this));
    uPtr(Obj())->Item(::STRINGS[15/*"getResponse...*/], uDelegate::New(::TYPES[7/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetResponseType_fn, this));
    uPtr(Obj())->Item(::STRINGS[16/*"sendAsync"*/], uDelegate::New(::TYPES[7/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__SendAsync_fn, this));
    uPtr(Obj())->Item(::STRINGS[17/*"abort"*/], ::g::Fuse::Scripting::JSCallback::FromAction(uDelegate::New(::TYPES[13/*Uno.Action*/], (void*)Http__FuseJSHttpRequest__Abort_fn, this)));
    uPtr(Obj())->Item(::STRINGS[18/*"setHeader"*/], ::g::Fuse::Scripting::JSCallback::FromAction2(::TYPES[14/*Fuse.Scripting.JSCallback.FromAction<string, string>*/], uDelegate::New(::TYPES[15/*Uno.Action<string, string>*/], (void*)Http__FuseJSHttpRequest__SetHeader_fn, this)));
    uPtr(Obj())->Item(::STRINGS[19/*"getResponse...*/], ::g::Fuse::Scripting::JSCallback::FromFunc1(::TYPES[16/*Fuse.Scripting.JSCallback.FromFunc<string, string>*/], uDelegate::New(::TYPES[17/*Uno.Func<string, string>*/], (void*)Http__FuseJSHttpRequest__GetResponseHeader_fn, this)));
    uPtr(Obj())->Item(::STRINGS[20/*"getResponse...*/], ::g::Fuse::Scripting::JSCallback::FromFunc(::TYPES[18/*Fuse.Scripting.JSCallback.FromFunc<string>*/], uDelegate::New(::TYPES[19/*Uno.Func<string>*/], (void*)Http__FuseJSHttpRequest__GetResponseHeaders_fn, this)));
    uPtr(Obj())->Item(::STRINGS[21/*"getState"*/], uDelegate::New(::TYPES[7/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetState_fn, this));
    uPtr(Obj())->Item(::STRINGS[22/*"getResponse...*/], ::g::Fuse::Scripting::JSCallback::FromFunc(::TYPES[20/*Fuse.Scripting.JSCallback.FromFunc<int>*/], uDelegate::New(::TYPES[21/*Uno.Func<int>*/], (void*)Http__FuseJSHttpRequest__GetResponseStatus_fn, this)));
    uPtr(Obj())->Item(::STRINGS[23/*"getResponse...*/], uDelegate::New(::TYPES[7/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetResponseReasonPhrase_fn, this));
    uPtr(Obj())->Item(::STRINGS[24/*"getResponse...*/], uDelegate::New(::TYPES[7/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetResponseContentString_fn, this));
    uPtr(Obj())->Item(::STRINGS[25/*"getResponse...*/], uDelegate::New(::TYPES[7/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetResponseContentByteArray_fn, this));
}
...
{
    uPtr(uPtr(result)->Object)->Item(::STRINGS[35/*"exports"*/], Http__FunctionClosure::New1(c, uDelegate::New(::TYPES[24/*Uno.Func<Fuse.Scripting.Context, object[], object>*/], (void*)Http__CreateClient_fn, __this))->Callback());
}
...
static void HttpHeaders_build(uType* type)
{
    ...
    ::TYPES[27] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(8/*ToArray<string>*/, ::g::Uno::String_typeof(), NULL);
...
uString* HttpHeaders::GetValue(uString* key)
{
    ...
    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(_headers), ::g::Uno::String::ToLower(uPtr(key)), (void**)(&list), &ret6), ret6))
        return ::g::Uno::String::Join(::STRINGS[36/*", "*/], (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[27/*Uno.Collections.EnumerableExtensions.ToArray<string>*/], list));
...
{
    ::STRINGS[38] = uString::Const("receivedUri");
    ::STRINGS[39] = uString::Const("FuseJS/InterApp");
    ::STRINGS[40] = uString::Const("onReceivedUri");
    ::STRINGS[41] = uString::Const("launchUri");
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[5] = ::g::Fuse::Scripting::NativeCallback_typeof();
...
{
    ctor_2(true, uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, ::STRINGS[38/*"receivedUri"*/]));

    if (InterApp::_instance_ != NULL)
        return;

    ::g::Uno::UX::Resource::SetGlobalKey(InterApp::_instance_ = this, ::STRINGS[39/*"FuseJS/Inte...*/]);
    ::g::Fuse::Scripting::NativeEvent* onReceivedUri = ::g::Fuse::Scripting::NativeEvent::New4(::STRINGS[40/*"onReceivedUri"*/], true);
    On1(::STRINGS[38/*"receivedUri"*/], onReceivedUri);
    AddMember(onReceivedUri);
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[41/*"launchUri"*/], uDelegate::New(::TYPES[5/*Fuse.Scripting.NativeCallback*/], (void*)InterApp__LaunchUri_fn)));
...
{
    Emit(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, ::STRINGS[38/*"receivedUri"*/], uri));
}
...
{
    ::STRINGS[42] = uString::Const("FuseJS/Maps");
    ::STRINGS[43] = uString::Const("openAt");
    ::STRINGS[44] = uString::Const("searchNearby");
    ::STRINGS[45] = uString::Const("searchNear");
    ::TYPES[5] = ::g::Fuse::Scripting::NativeCallback_typeof();
    ::TYPES[6] = ::g::Uno::String_typeof();
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Fuse::Scripting::NativeModule_type, interface0),
...
void Maps::ctor_2()
{
    ...
    ::g::Uno::UX::Resource::SetGlobalKey(Maps::_instance_ = this, ::STRINGS[42/*"FuseJS/Maps"*/]);
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[43/*"openAt"*/], uDelegate::New(::TYPES[5/*Fuse.Scripting.NativeCallback*/], (void*)Maps__OpenAt_fn)));
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[44/*"searchNearby"*/], uDelegate::New(::TYPES[5/*Fuse.Scripting.NativeCallback*/], (void*)Maps__SearchNearby_fn)));
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[45/*"searchNear"*/], uDelegate::New(::TYPES[5/*Fuse.Scripting.NativeCallback*/], (void*)Maps__SearchNear_fn)));
}
...
{
    ::STRINGS[46] = uString::Const("FuseJS/Phone");
    ::STRINGS[47] = uString::Const("call");
    ::TYPES[5] = ::g::Fuse::Scripting::NativeCallback_typeof();
    ::TYPES[6] = ::g::Uno::String_typeof();
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Fuse::Scripting::NativeModule_type, interface0),
...
{
    ctor_1();
    ::g::Uno::UX::Resource::SetGlobalKey(Phone::_instance_ = this, ::STRINGS[46/*"FuseJS/Phone"*/]);
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[47/*"call"*/], uDelegate::New(::TYPES[5/*Fuse.Scripting.NativeCallback*/], (void*)Phone__Call_fn)));
}
...
{
    ::STRINGS[0] = uString::Const("FuseJS/Timer");
    ::STRINGS[48] = uString::Const("create");
    ::STRINGS[49] = uString::Const("delete");
    ::STRINGS[50] = uString::Const("create(): requires at least three arguments");
    ::STRINGS[51] = uString::Const("create(): first argument must be a function");
    ::STRINGS[52] = uString::Const("delete(): requires one argument");
    ::TYPES[5] = ::g::Fuse::Scripting::NativeCallback_typeof();
...
void TimerModule::ctor_2()
{
    ...
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[48/*"create"*/], uDelegate::New(::TYPES[5/*Fuse.Scripting.NativeCallback*/], (void*)TimerModule__Create_fn, this)));
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[49/*"delete"*/], uDelegate::New(::TYPES[5/*Fuse.Scripting.NativeCallback*/], (void*)TimerModule__Delete_fn, this)));
...
uObject* TimerModule::Create(::g::Fuse::Scripting::Context* context, uArray* args)
{
    if (uPtr(args)->Length() < 3)
        U_THROW(::g::Fuse::Scripting::Error::New4(::STRINGS[50/*"create(): r...*/]));

    if (!uIs((uObject*)uPtr(args)->Strong<uObject*>(0), ::TYPES[2/*Fuse.Scripting.Function*/]))
        U_THROW(::g::Fuse::Scripting::Error::New4(::STRINGS[51/*"create(): f...*/]));
...
uObject* TimerModule::Delete(::g::Fuse::Scripting::Context* context, uArray* args)
{
    if (uPtr(args)->Length() < 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::STRINGS[52/*"delete(): r...*/]));
