...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScriptCore/0.41.3/$.uno
// ------------------------------------------------------------------------
...
static void JSValueRef_build(uType* type)
{
    ...
    ::STRINGS[22] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScriptCore/0.41.3/$.uno");
    ::TYPES[16] = uObject_typeof()->Array();
    ::TYPES[18] = ::g::Uno::IDisposable_typeof();
...
{
    ::g::Uno::Diagnostics::Debug::Assert(JSValueRef::IsObject(__this, ctx), ::STRINGS[21/*"(&this).IsO...*/], ::STRINGS[22/*"/usr/local/...*/], 474, uArray::Init<uObject*>(::TYPES[16/*object[]*/], 1, uBox(::g::Fuse::Scripting::JavaScriptCore::JSContextRef_typeof(), ctx)));
