...
// /usr/local/share/uno/Packages/FuseJS/0.41.3/$.uno
// -------------------------------------------------
...
static void Base64_build(uType* type)
{
    ...
    ::TYPES[2] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2/*FirstOrDefault<object>*/, uObject_typeof(), NULL);
...
void Environment::ctor_2()
{
    ...
    AddMember((::g::Fuse::Scripting::NativeProperty__New3_fn(::TYPES[13/*Fuse.Scripting.NativeProperty<bool, bool>*/], ::STRINGS[19/*"android"*/], uCRef(false), &ret2), ret2));
    AddMember((::g::Fuse::Scripting::NativeProperty__New3_fn(::TYPES[13/*Fuse.Scripting.NativeProperty<bool, bool>*/], ::STRINGS[20/*"ios"*/], uCRef(true), &ret3), ret3));
...
static void RaiseEvent_build(uType* type)
{
    ...
    ::STRINGS[54] = uString::Const("/usr/local/share/uno/Packages/FuseJS/0.41.3/$.uno");
...
void RaiseEvent::Raise()
{
    ...
    if (dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[53/*"Cannot find...*/], Name), this, ::STRINGS[54/*"/usr/local/...*/], 888, ::STRINGS[55/*"Raise"*/]);
        return;
    }
...
uObject* UserEvents::Raise(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[58/*"The FuseJS/...*/], context, ::STRINGS[54/*"/usr/local/...*/], 919, ::STRINGS[55/*"Raise"*/]);
