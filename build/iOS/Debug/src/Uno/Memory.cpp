// This file was generated based on /usr/local/share/uno/Packages/UnoCore/0.41.5/backends/cplusplus/Uno/Memory.cpp.
...
{
    fprintf(fp, "\tglobal_ref_at_%x [label=\"%s\" color=\"blue\"]\n",
            object, label);
    if (*object)
...
{
    if (target)
        fprintf(fp, "\tobject_at_%x -> object_at_%x [label=\"%s\"]\n", object, target, label);
}
