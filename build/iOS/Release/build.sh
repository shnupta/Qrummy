#!/bin/bash
# This file was generated based on /usr/local/share/uno/Packages/UnoCore/0.41.5/targets/ios/build.sh.
...
##else
    xcodebuild -project "Qrummy.xcodeproj" "$@" | tee >(checkForError)
##endif
