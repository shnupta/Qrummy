// This file was generated based on /usr/local/share/uno/Packages/UnoCore/0.41.5/source/opengl/$.uno.
...
struct GL : uObject
{
    ...
    static void BufferData(int target, int sizeInBytes, int usage);
    ...
    static void UniformMatrix41(int location, bool transpose, uArray* value);
