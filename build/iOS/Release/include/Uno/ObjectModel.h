// This file was generated based on /usr/local/share/uno/Packages/UnoCore/0.41.5/backends/cplusplus/Uno/ObjectModel.h.
...
T uCast(uObject* object, const uType* type) {
    U_ASSERT(sizeof(T) == type->ValueSize);
    if (object && !object->__type->Is(type)) U_THROW_ICE();
    return (T)object;
}
template<class T>
T uPtr(const T& ptr) {
