...
// private static string BundleFilePath(string resource) :565
void FontCache__BundleFilePath_fn(uString* resource, uString** __retval)
{
    *__retval = FontCache::BundleFilePath(resource);
}

// public static ObjC.Object Get(Fuse.Internal.FontFaceDescriptor descriptor, float size) :504
...
// private static string GetOptionalPath(Uno.UX.FileSource fileSource) :550
...
// private static ObjC.Object UIFontWithDescriptorAndSize(ObjC.Object descriptor, float size) :571
...
// private static string BundleFilePath(string resource) [static] :565
...
// public static ObjC.Object Get(Fuse.Internal.FontFaceDescriptor descriptor, float size) [static] :504
uObject* FontCache::Get(::g::Fuse::Internal::FontFaceDescriptor* descriptor, float size)
{
    FontCache_typeof()->Init();
    bool ret1;
    bool ret2;
    ...
    {
        uObject* uifontdescriptor = ::g::Fuse::Internal::iOSSystemFont::GetMatchingUIFontDescriptor(path, uPtr(descriptor)->Index, uDelegate::New(::TYPES[2/*Uno.Predicate<string>*/], (void*)::g::Fuse::Internal::FontFaceDescriptor__Match_fn, uPtr(descriptor)));
    ...
    else
    {
        ...
        uObject* uifontdescriptor1 = ::g::Fuse::Internal::iOSSystemFont::GetMatchingUIFontDescriptor(path, descriptor->Index, uDelegate::New(::TYPES[2/*Uno.Predicate<string>*/], (void*)::g::Fuse::Internal::FontFaceDescriptor__Match_fn, descriptor));
...
// private static string GetOptionalPath(Uno.UX.FileSource fileSource) [static] :550
...
// private static ObjC.Object UIFontWithDescriptorAndSize(ObjC.Object descriptor, float size) [static] :571
uObject* FontCache::UIFontWithDescriptorAndSize(uObject* descriptor, float size)
{
    FontCache_typeof()->Init();
    @autoreleasepool
    {
        return ::g::Uno::Compiler::ExportTargetInterop::Foreign::ObjC::Object::New1([] (::id descriptor, float size) -> ::id
        {
            return [::UIFont fontWithDescriptor:(::UIFontDescriptor*)descriptor size:size];
        } (::g::ObjC::Helpers::GetHandle(descriptor), size));
