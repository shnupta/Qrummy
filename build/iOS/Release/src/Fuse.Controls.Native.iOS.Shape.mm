...
// internal abstract extern class Shape :1995
// {
static void Shape_build(uType* type)
{
    ::STRINGS[0] = uString::Const("");
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Native/0.41.3/ios/$.uno");
...
// private void Fuse.Controls.Native.IShapeView.Update(Fuse.Drawing.Brush[] fills, Fuse.Drawing.Stroke[] strokes, float pixelsPerPoint) :2036
...
// private static void MakeLayers(ObjC.Object handle, int layerCount) :2224
void Shape__MakeLayers_fn(uObject* handle, int* layerCount)
{
    Shape::MakeLayers(handle, *layerCount);
}

// protected void OnShapeChanged() :2042
void Shape__OnShapeChanged_fn(Shape* __this)
{
    __this->OnShapeChanged();
}

// private static int SelectOffset(Fuse.Drawing.GradientStop a, Fuse.Drawing.GradientStop b) :2094
...
// private void SetBrush(Fuse.Drawing.Brush brush, int layer, ObjC.Object path, bool isLine, float strokeWidth) :2070
...
// private static void SetBrush(ObjC.Object handle, float r, float g, float b, float a, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float opacity) :2202
...
// private void SetLinearGradient(Fuse.Drawing.LinearGradient gradient, int layer, ObjC.Object path, bool isLine, float strokeWidth) :2099
...
// private static void SetLinearGradient(ObjC.Object handle, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float startX, float startY, float endX, float endY, float[] colors, float[] offsets, float width, float height) :2131
...
// public override sealed void set_Transform(float4x4 value) :2015
...
// protected Shape(Fuse.Visual visual) [instance] :2000
...
// protected void OnShapeChanged() [instance] :2042
...
// private void SetBrush(Fuse.Drawing.Brush brush, int layer, ObjC.Object path, bool isLine, float strokeWidth) [instance] :2070
void Shape::SetBrush(::g::Fuse::Drawing::Brush* brush, int layer, uObject* path, bool isLine, float strokeWidth)
{
    ...
    else
    {
        ...
        if ((sc == NULL) && (ssc == NULL))
            ::g::Fuse::Diagnostics::Unsupported(::STRINGS[0/*""*/], brush, ::STRINGS[1/*"/usr/local/...*/], 2087, ::STRINGS[2/*"SetBrush"*/]);
...
// private void SetLinearGradient(Fuse.Drawing.LinearGradient gradient, int layer, ObjC.Object path, bool isLine, float strokeWidth) [instance] :2099
...
// protected generated float2 get_ShapePosition() [instance] :2012
::g::Uno::Float2 Shape::ShapePosition()
{
    return _ShapePosition;
}

// private generated void set_ShapePosition(float2 value) [instance] :2012
void Shape::ShapePosition(::g::Uno::Float2 value)
{
    _ShapePosition = value;
}

// protected generated float2 get_ShapeSize() [instance] :2023
::g::Uno::Float2 Shape::ShapeSize()
{
    return _ShapeSize;
}

// private generated void set_ShapeSize(float2 value) [instance] :2023
void Shape::ShapeSize(::g::Uno::Float2 value)
{
    _ShapeSize = value;
}

// private static ObjC.Object Create() [static] :2240
...
// private static void MakeLayers(ObjC.Object handle, int layerCount) [static] :2224
...
// private static int SelectOffset(Fuse.Drawing.GradientStop a, Fuse.Drawing.GradientStop b) [static] :2094
...
// private static void SetBrush(ObjC.Object handle, float r, float g, float b, float a, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float opacity) [static] :2202
...
// private static void SetLinearGradient(ObjC.Object handle, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float startX, float startY, float endX, float endY, float[] colors, float[] offsets, float width, float height) [static] :2131
