...
// internal sealed class Scale9Rectangle :1341
// {
// static Scale9Rectangle() :1341
...
// public generated Scale9Rectangle() :1341
void Scale9Rectangle__ctor__fn(Scale9Rectangle* __this)
{
    __this->ctor_();
}

// public void Draw(Fuse.DrawContext dc, Fuse.Visual element, float2 size, float2 scaleTextureSize, Uno.Graphics.VideoTexture tex, float4 margin) :1345
...
// private generated void init_DrawCalls() :1341
void Scale9Rectangle__init_DrawCalls_fn(Scale9Rectangle* __this)
{
    __this->init_DrawCalls();
}

// public generated Scale9Rectangle New() :1341
...
// public generated Scale9Rectangle() [instance] :1341
void Scale9Rectangle::ctor_()
{
    init_DrawCalls();
}

// public void Draw(Fuse.DrawContext dc, Fuse.Visual element, float2 size, float2 scaleTextureSize, Uno.Graphics.VideoTexture tex, float4 margin) [instance] :1345
...
// private generated void init_DrawCalls() [instance] :1341
...
// public generated Scale9Rectangle New() [static] :1341
...
// internal sealed class VideoDrawElement :1310
// {
// static VideoDrawElement() :1310
...
// public generated VideoDrawElement() :1310
void VideoDrawElement__ctor__fn(VideoDrawElement* __this)
{
    __this->ctor_();
}

// public void Draw(Fuse.DrawContext dc, Fuse.Visual element, float2 offset, float2 size, float2 uvPosition, float2 uvSize, Uno.Graphics.VideoTexture tex, int rotation) :1314
...
// private generated void init_DrawCalls() :1310
void VideoDrawElement__init_DrawCalls_fn(VideoDrawElement* __this)
{
    __this->init_DrawCalls();
}

// public generated VideoDrawElement New() :1310
...
// public generated VideoDrawElement() [instance] :1310
void VideoDrawElement::ctor_()
{
    init_DrawCalls();
}

// public void Draw(Fuse.DrawContext dc, Fuse.Visual element, float2 offset, float2 size, float2 uvPosition, float2 uvSize, Uno.Graphics.VideoTexture tex, int rotation) [instance] :1314
...
// private generated void init_DrawCalls() [instance] :1310
...
// public generated VideoDrawElement New() [static] :1310
...
{
    ::STRINGS[2] = uString::Const("Video not supported on this platform");
}
...
::g::Uno::Threading::Future1* VideoLoader::Load(uString* url)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::STRINGS[2/*"Video not s...*/]));
}
...
{
    ::STRINGS[3] = uString::Const("Video error");
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Video/0.41.3/$.uno");
    ::STRINGS[5] = uString::Const("Fuse.Controls.VideoImpl.IVideoCallbacks.OnError");
    ::STRINGS[6] = uString::Const("IPlayback.PlayTo(double) not supported in Fuse.Controls.Video");
    ::STRINGS[7] = uString::Const("Fuse.Triggers.IPlayback.PlayTo");
...
// public override sealed void Draw(Fuse.DrawContext dc) :1279
...
// private bool get_FlipSize() :1232
void VideoVisual__get_FlipSize_fn(VideoVisual* __this, bool* __retval)
{
    *__retval = __this->FlipSize();
}

// private void Fuse.Controls.VideoImpl.IVideoCallbacks.OnCompleted() :1095
...
void VideoVisual__FuseControlsVideoImplIVideoCallbacksOnError_fn(VideoVisual* __this, ::g::Uno::Exception* e)
{
    ...
    ::g::Fuse::Diagnostics::UnknownException(::STRINGS[3/*"Video error"*/], e, __this, ::STRINGS[4/*"/usr/local/...*/], 1080, ::STRINGS[5/*"Fuse.Contro...*/]);
}
...
// private void Fuse.Controls.VideoImpl.IVideoCallbacks.OnLoading() :1083
...
// private void Fuse.Controls.VideoImpl.IVideoCallbacks.OnReady() :1089
...
// private double Fuse.Triggers.IMediaPlayback.get_Position() :1110
...
// private void Fuse.Triggers.IMediaPlayback.set_Position(double value) :1111
...
// private void Fuse.Triggers.IPlayback.PlayTo(double progress) :1125
void VideoVisual__FuseTriggersIPlaybackPlayTo_fn(VideoVisual* __this, double* progress)
{
    ::g::Fuse::Diagnostics::Unsupported(::STRINGS[6/*"IPlayback.P...*/], __this, ::STRINGS[4/*"/usr/local/...*/], 1127, ::STRINGS[7/*"Fuse.Trigge...*/]);
}

// private double Fuse.Triggers.IPlayback.get_Progress() :1158
...
// private void Fuse.Triggers.IPlayback.set_Progress(double value) :1159
...
// private void Fuse.Triggers.IPlayback.Resume() :1141
...
// private void Fuse.Triggers.IPlayback.Stop() :1119
...
// private double Fuse.Triggers.IProgress.get_Progress() :1153
void VideoVisual__FuseTriggersIProgressget_Progress_fn(VideoVisual* __this, double* __retval)
{
    return *__retval = (::g::Fuse::Controls::VideoImpl::IVideoService::Duration(uInterface(uPtr(__this->_videoService), ::TYPES[18/*Fuse.Controls.VideoImpl.IVideoService*/])) > 1e-05) ? ::g::Fuse::Controls::VideoImpl::IVideoService::Position(uInterface(uPtr(__this->_videoService), ::TYPES[18/*Fuse.Controls.VideoImpl.IVideoService*/])) / ::g::Fuse::Controls::VideoImpl::IVideoService::Duration(uInterface(uPtr(__this->_videoService), ::TYPES[18/*Fuse.Controls.VideoImpl.IVideoService*/])) : 0.0, void();
}

// private void Fuse.Triggers.IProgress.add_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) :1169
void VideoVisual__FuseTriggersIProgressadd_ProgressChanged_fn(VideoVisual* __this, uDelegate* value)
{
    __this->add_ProgressChanged(value);
}

// private void Fuse.Triggers.IProgress.remove_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) :1170
void VideoVisual__FuseTriggersIProgressremove_ProgressChanged_fn(VideoVisual* __this, uDelegate* value)
{
    __this->remove_ProgressChanged(value);
}

// public override sealed float2 GetMarginSize(Fuse.LayoutParams lp) :1239
...
// protected override sealed float2 OnArrangeMarginBox(float2 position, Fuse.LayoutParams lp) :1260
...
// protected override sealed void OnHitTest(Fuse.HitTestContext htc) :1297
...
// private void OnParamChanged(object sender, Uno.EventArgs args) :1199
...
// private void OnProgressChanged() :1174
void VideoVisual__OnProgressChanged_fn(VideoVisual* __this)
{
    __this->OnProgressChanged();
}

// private void OnRenderParamChanged(object sender, Uno.EventArgs args) :1190
...
// private void OnSourceChanged(object sender, Uno.EventArgs args) :1206
...
// private generated void add_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) :1173
void VideoVisual__add_ProgressChanged_fn(VideoVisual* __this, uDelegate* value)
{
    __this->add_ProgressChanged(value);
}

// private generated void remove_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) :1173
void VideoVisual__remove_ProgressChanged_fn(VideoVisual* __this, uDelegate* value)
{
    __this->remove_ProgressChanged(value);
}

// private void ResetTriggers() :1221
...
// private bool get_FlipSize() [instance] :1232
...
// private float2 GetSize() [instance] :1247
...
// private void OnParamChanged(object sender, Uno.EventArgs args) [instance] :1199
...
// private void OnProgressChanged() [instance] :1174
...
// private void OnRenderParamChanged(object sender, Uno.EventArgs args) [instance] :1190
...
// private void OnSourceChanged(object sender, Uno.EventArgs args) [instance] :1206
...
// private generated void add_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) [instance] :1173
...
// private generated void remove_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) [instance] :1173
...
// private void ResetTriggers() [instance] :1221
void VideoVisual::ResetTriggers()
{
    ...
    ::g::Fuse::Triggers::WhileFailed::SetState((::g::Fuse::Controls::Graphics::ControlVisual__get_Control_fn(this, &ret38), ret38), false, ::STRINGS[8/*""*/]);
