...
static void Mesh_build(uType* type)
{
    ...
    ::TYPES[5] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(8/*ToArray<Fuse.Drawing.Batching.Batch>*/, ::g::Fuse::Drawing::Batching::Batch_typeof(), NULL);
    type->SetInterfaces(
...
static void MeshBatchingEngine_build(uType* type)
{
    ...
    ::TYPES[13] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2/*FirstOrDefault<Fuse.Drawing.Batching.Batch>*/, ::g::Fuse::Drawing::Batching::Batch_typeof(), NULL);
