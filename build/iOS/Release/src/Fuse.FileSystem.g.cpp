...
static void FileSystemModule_build(uType* type)
{
    ...
    ::STRINGS[38] = uString::Const("(Date Converter)");
    ...
    type->MethodTypes[1]->SetPrecalc(
        ::TYPES[27/*Uno.Collections.EnumerableExtensions*/]->MakeMethod(4/*OfType<T, object>*/, type->MethodTypes[1]->U(0), uObject_typeof(), NULL),
...
// private Uno.Collections.Dictionary<string, string> GetIosPaths() :532
...
// private Uno.Collections.Dictionary<string, string> GetIosPaths() [instance] :532
...
uObject* FileSystemModule::ToScriptingDate(::g::Fuse::Scripting::Context* context, ::g::Uno::Time::ZonedDateTime* time)
{
    ...
    return uPtr(context)->Evaluate(::STRINGS[38/*"(Date Conve...*/], ::g::Uno::String::Format(::STRINGS[39/*"new Date({0})"*/], uArray::Init<uObject*>(::TYPES[29/*object[]*/], 1, uBox<int64_t>(::g::Uno::Long_typeof(), msSinceUnixEpoch))));
}
...
static void FileSystemOperations_build(uType* type)
{
    ...
    ::TYPES[46] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(8/*ToArray<string>*/, ::g::Uno::String_typeof(), NULL);
    ::TYPES[47] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(6/*Select<string, string>*/, ::g::Uno::String_typeof(), ::g::Uno::String_typeof(), NULL);
