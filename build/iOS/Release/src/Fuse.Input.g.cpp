...
static void Pointer_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("SoftCapture requires lostCallback Action");
    ::STRINGS[9] = uString::Const("SoftCapture requires identity object");
    ::STRINGS[10] = uString::Const("SoftCapture requires softCapturer Visual");
...
bool Pointer::SoftCapture(int pointIndex, ::g::Fuse::Visual* softCapturer, uObject* identity, uDelegate* lostCallback)
{
    ...
    if (::g::Uno::Delegate::op_Equality(lostCallback, NULL))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[8/*"SoftCapture...*/]));

    if (identity == NULL)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[9/*"SoftCapture...*/]));
...
{
    ::STRINGS[11] = uString::Const("x");
    ::STRINGS[12] = uString::Const("y");
    ::STRINGS[13] = uString::Const("index");
    ::STRINGS[14] = uString::Const("localX");
    ::STRINGS[15] = uString::Const("localY");
...
{
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(uPtr(s), ::TYPES[36/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[11/*"x"*/], (double)__this->WindowPoint().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(s, ::TYPES[36/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[12/*"y"*/], (double)__this->WindowPoint().Y);
    ::g::Fuse::Scripting::IEventSerializer::AddInt(uInterface(s, ::TYPES[36/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[13/*"index"*/], __this->PointIndex());
    ::g::Uno::Float2 localPoint = uPtr(__this->Visual())->WindowToLocal(__this->WindowPoint());
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(s, ::TYPES[36/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[14/*"localX"*/], (double)localPoint.X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(s, ::TYPES[36/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[15/*"localY"*/], (double)localPoint.Y);
}
