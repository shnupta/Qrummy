...
void EdgeNavigation__OnRooted_fn(EdgeNavigation* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[5/*"Element"*/], __this->Parent(), __this, ::STRINGS[1/*"/usr/local/...*/], 357, ::STRINGS[6/*"OnRooted"*/]);
...
void NavigateToggle__Perform1_fn(NavigateToggle* __this, uObject* ctx, ::g::Fuse::Node* n)
{
    ...
    if (page != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[10/*"No Page was...*/], __this, ::STRINGS[1/*"/usr/local/...*/], 3789, ::STRINGS[2/*"Perform"*/]);
}
...
uObject* Navigation::TryFindBaseNavigation1(::g::Fuse::Node* node, ::g::Fuse::Visual** parent)
{
    ...
    *parent = NULL;
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[11/*"TryFindBase...*/], node, ::STRINGS[1/*"/usr/local/...*/], 1192, ::STRINGS[12/*"TryFindBase...*/]);
        return NULL;
    }
...
::g::Fuse::Visual* Navigation::TryFindPage(::g::Fuse::Node* node, uObject** nav, ::g::Fuse::Visual** pageBind)
{
    ...
    *pageBind = NULL;
    ...
    if (!uPtr(node)->IsRootingStarted())
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[13/*"TryFindPage...*/], node, ::STRINGS[1/*"/usr/local/...*/], 1253, ::STRINGS[14/*"TryFindPage"*/]);
        return NULL;
    }
                ...
                *pageBind = v;
                ...
                if (uPtr(p)->IsRootingStarted())
                {
                    *nav = Navigation::TryFind(p);
                    ...
                    if (*nav == NULL)
                    {
                        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[15/*"`Page` set ...*/], p, ::STRINGS[1/*"/usr/local/...*/], 1274, ::STRINGS[14/*"TryFindPage"*/]);
                        return NULL;
                    }
                }
...
void NavigationPageProxy::OnPageRootingCompleted()
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[16/*"Got an unde...*/], this, ::STRINGS[1/*"/usr/local/...*/], 1404, ::STRINGS[17/*"OnPageRooti...*/]);
        return;
    }
...
void NavigationPageProxy::Rooted(::g::Fuse::Visual* source)
{
    ...
    if (_source == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[18/*"Attempting ...*/], this, ::STRINGS[1/*"/usr/local/...*/], 1367, ::STRINGS[19/*"Rooted"*/]);
        return;
    }
    ...
    if (Page() == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[20/*"Unable to l...*/], this, ::STRINGS[1/*"/usr/local/...*/], 1374, ::STRINGS[19/*"Rooted"*/]);
        return;
    }
    ...
    if (_navigation == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[21/*"Something w...*/], this, ::STRINGS[1/*"/usr/local/...*/], 1391, ::STRINGS[19/*"Rooted"*/]);
        return;
    }
...
void NavigationTriggerAction__Perform_fn(NavigationTriggerAction* __this, ::g::Fuse::Node* n)
{
    ...
    if (ctx == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[22/*"No navigati...*/], __this, ::STRINGS[1/*"/usr/local/...*/], 3688, ::STRINGS[2/*"Perform"*/]);
        return;
    }
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[25/*Fuse.Scripting.ScriptMember[]*/], 7, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[26/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.Router>*/], ::STRINGS[27/*"goto"*/], uDelegate::New(::TYPES[27/*Uno.Action<Fuse.Scripting.Context, Fuse.Navigation.Router, object[]>*/], (void*)Router__Goto1_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[26/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.Router>*/], ::STRINGS[28/*"gotoRelative"*/], uDelegate::New(::TYPES[27/*Uno.Action<Fuse.Scripting.Context, Fuse.Navigation.Router, object[]>*/], (void*)Router__GotoRelative_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[26/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.Router>*/], ::STRINGS[29/*"push"*/], uDelegate::New(::TYPES[27/*Uno.Action<Fuse.Scripting.Context, Fuse.Navigation.Router, object[]>*/], (void*)Router__Push1_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[26/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.Router>*/], ::STRINGS[30/*"pushRelative"*/], uDelegate::New(::TYPES[27/*Uno.Action<Fuse.Scripting.Context, Fuse.Navigation.Router, object[]>*/], (void*)Router__PushRelative_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[26/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.Router>*/], ::STRINGS[31/*"goBack"*/], uDelegate::New(::TYPES[27/*Uno.Action<Fuse.Scripting.Context, Fuse.Navigation.Router, object[]>*/], (void*)Router__GoBack1_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[26/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.Router>*/], ::STRINGS[32/*"getRoute"*/], uDelegate::New(::TYPES[27/*Uno.Action<Fuse.Scripting.Context, Fuse.Navigation.Router, object[]>*/], (void*)Router__GetRoute_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[26/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.Router>*/], ::STRINGS[33/*"modify"*/], uDelegate::New(::TYPES[27/*Uno.Action<Fuse.Scripting.Context, Fuse.Navigation.Router, object[]>*/], (void*)Router__Modify1_fn), 2)));
}

static void Router_build(uType* type)
{
    ::STRINGS[27] = uString::Const("goto");
    ::STRINGS[28] = uString::Const("gotoRelative");
    ::STRINGS[29] = uString::Const("push");
    ::STRINGS[30] = uString::Const("pushRelative");
    ::STRINGS[31] = uString::Const("goBack");
    ::STRINGS[32] = uString::Const("getRoute");
    ::STRINGS[33] = uString::Const("modify");
    ::STRINGS[34] = uString::Const("Router.gotoRelative(): requires 1+ parameters");
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/0.41.3/$.uno");
    ::STRINGS[35] = uString::Const("GetRelative");
    ::STRINGS[36] = uString::Const("Router.gotoRelative(): did not find an outlet from the provided Node");
    ::STRINGS[37] = uString::Const("Router.getRoute(): must provide exactly 1 argument.");
    ::STRINGS[38] = uString::Const("GetRoute");
    ::STRINGS[39] = uString::Const("Router.getRoute(): argument must be a function.");
    ::STRINGS[40] = uString::Const("Router.goBack takes no parameters");
    ::STRINGS[41] = uString::Const("GoBack");
    ::STRINGS[42] = uString::Const("Router.goto(): invalid route provided");
    ::STRINGS[43] = uString::Const("Goto");
    ::STRINGS[44] = uString::Const("`Router.modify` takes one argument");
    ::STRINGS[45] = uString::Const("Modify");
    ::STRINGS[46] = uString::Const("`Router.modify` should be passed an object");
    ::STRINGS[47] = uString::Const("how");
    ::STRINGS[48] = uString::Const("path");
    ::STRINGS[49] = uString::Const("`path` should be an array");
    ::STRINGS[50] = uString::Const("relative");
    ::STRINGS[51] = uString::Const("Could not find an outlet from the `relative` node");
    ::STRINGS[52] = uString::Const("transition");
    ::STRINGS[53] = uString::Const("Unrecognized argument: ");
    ::STRINGS[54] = uString::Const("Cannot pop() - history is empty");
    ::STRINGS[55] = uString::Const("Pop");
    ::STRINGS[56] = uString::Const("Unable to navigate to route: ");
    ::STRINGS[57] = uString::Const("SetRoute");
    ::STRINGS[58] = uString::Const("No router outlet found to handle route: ");
    ::STRINGS[59] = uString::Const("SetRouteImpl");
    ::STRINGS[60] = uString::Const("SubRoute requested but outlet has no active path: ");
    ::STRINGS[61] = uString::Const("Route parameter must be serializeable, it contains reference loops or is too large");
    ::STRINGS[62] = uString::Const("ValidateParameter");
    ::STRINGS[63] = uString::Const("Route parameter must be serializeable, cannot contain Observables.");
    ::STRINGS[64] = uString::Const("Route parameter must be serializeable, cannot contain functions.");
...
void Router::Pop()
{
    ...
    if (uPtr(_history)->Count() == 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[54/*"Cannot pop(...*/], this, ::STRINGS[1/*"/usr/local/...*/], 2381, ::STRINGS[55/*"Pop"*/]);
        return;
    }
...
::g::Fuse::Navigation::Route* Router::SetRoute(::g::Fuse::Navigation::Route* r, int gotoMode, int operation, bool userRequest)
{
    ...
    if (outR == NULL)
    {
        uString* msg = ::g::Uno::String::op_Addition2(::STRINGS[56/*"Unable to n...*/], uPtr(r)->Format());

        if (userRequest)
            ::g::Fuse::Diagnostics::UserError(msg, this, ::STRINGS[1/*"/usr/local/...*/], 2403, ::STRINGS[57/*"SetRoute"*/]);
        else
            ::g::Fuse::Diagnostics::InternalError(msg, this, ::STRINGS[1/*"/usr/local/...*/], 2405, ::STRINGS[57/*"SetRoute"*/]);
...
::g::Fuse::Navigation::Route* Router::SetRouteImpl(::g::Fuse::Visual* root, ::g::Fuse::Navigation::Route* r, int gotoMode, int operation)
{
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[58/*"No router o...*/], r), this, ::STRINGS[1/*"/usr/local/...*/], 2422, ::STRINGS[59/*"SetRouteImpl"*/]);
        return NULL;
    }
    ...
    if (r->SubRoute != NULL)
    {
        if (active == NULL)
        {
            ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[60/*"SubRoute re...*/], r), this, ::STRINGS[1/*"/usr/local/...*/], 2444, ::STRINGS[59/*"SetRouteImpl"*/]);
            return NULL;
        }
        else
        {
...
::g::Fuse::Navigation::Route* Router::GetRelative(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[34/*"Router.goto...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1827, ::STRINGS[35/*"GetRelative"*/]);
        return NULL;
    }
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[36/*"Router.goto...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1835, ::STRINGS[35/*"GetRelative"*/]);
        return NULL;
    }
...
void Router::GetRoute(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[37/*"Router.getR...*/], r, ::STRINGS[1/*"/usr/local/...*/], 2073, ::STRINGS[38/*"GetRoute"*/]);
        return;
    }
    ...
    if (callback == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[39/*"Router.getR...*/], r, ::STRINGS[1/*"/usr/local/...*/], 2079, ::STRINGS[38/*"GetRoute"*/]);
        return;
    }
...
void Router::GoBack1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[40/*"Router.goBa...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1882, ::STRINGS[41/*"GoBack"*/]);
        return;
    }
...
void Router::Goto1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (where != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[42/*"Router.goto...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1774, ::STRINGS[43/*"Goto"*/]);
}
...
void Router::Modify1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[44/*"`Router.mod...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1922, ::STRINGS[45/*"Modify"*/]);
        return;
    }
    ...
    if (obj == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[46/*"`Router.mod...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1929, ::STRINGS[45/*"Modify"*/]);
        return;
    }
    ...
    for (int i = 0; i < uPtr(keys)->Length(); ++i)
    {
        ...
        if (::g::Uno::String::op_Equality(p, ::STRINGS[47/*"how"*/]))
        ...
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[48/*"path"*/]))
        {
            uObject* path = uAs<uObject*>(o, ::TYPES[33/*Fuse.Scripting.IArray*/]);

            if (path == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[49/*"`path` shou...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1952, ::STRINGS[45/*"Modify"*/]);
                return;
            }

            route = Router::ParseRoute(c, path);
        }
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[50/*"relative"*/]))
        {
            ...
            if (relative == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[51/*"Could not f...*/], r, ::STRINGS[1/*"/usr/local/...*/], 1964, ::STRINGS[45/*"Modify"*/]);
                return;
            }
        }
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[52/*"transition"*/]))
        ...
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[53/*"Unrecognize...*/], p), r, ::STRINGS[1/*"/usr/local/...*/], 1974, ::STRINGS[45/*"Modify"*/]);
            return;
        }
    }
...
bool Router::ValidateParameter(::g::Fuse::Scripting::Context* c, uObject* arg, int depth)
{
    ...
    if (depth > 50)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[61/*"Route param...*/], NULL, ::STRINGS[1/*"/usr/local/...*/], 1992, ::STRINGS[62/*"ValidatePar...*/]);
        return false;
    }
    ...
    if (uIs(arg, ::TYPES[31/*Fuse.Scripting.Object*/]))
    {
        ...
        {
            ::g::Fuse::Diagnostics::UserError(::STRINGS[63/*"Route param...*/], NULL, ::STRINGS[1/*"/usr/local/...*/], 2001, ::STRINGS[62/*"ValidatePar...*/]);
            return false;
        }
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[64/*"Route param...*/], NULL, ::STRINGS[1/*"/usr/local/...*/], 2024, ::STRINGS[62/*"ValidatePar...*/]);
        return false;
    }
...
{
    ::STRINGS[65] = uString::Const("Seek being called on an unrooted navigation");
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/0.41.3/$.uno");
    ::STRINGS[66] = uString::Const("Fuse.Navigation.ISeekableNavigation.Seek");
    ::STRINGS[67] = uString::Const("Attempting to navigate to element with different parent");
    ::STRINGS[68] = uString::Const("GotoImpl");
    ::STRINGS[69] = uString::Const("Updated called without a region");
    ::STRINGS[70] = uString::Const("OnUpdated");
    ::STRINGS[71] = uString::Const("Motion should not be changed post-rooting");
    ::STRINGS[72] = uString::Const("set_Motion");
...
void StructuredNavigation__FuseNavigationISeekableNavigationSeek_fn(StructuredNavigation* __this, ::g::Fuse::Navigation::UpdateSeekArgs* args)
{
    ...
    if (__this->_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[65/*"Seek being ...*/], __this, ::STRINGS[1/*"/usr/local/...*/], 3117, ::STRINGS[66/*"Fuse.Naviga...*/]);
        return;
    }
...
void StructuredNavigation::GotoImpl(::g::Fuse::Visual* element, int mode)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[67/*"Attempting ...*/], element, ::STRINGS[1/*"/usr/local/...*/], 2824, ::STRINGS[68/*"GotoImpl"*/]);
        SetActive(NULL);
        return;
    }
...
void StructuredNavigation::Motion(::g::Fuse::Motion::MotionConfig* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(::STRINGS[71/*"Motion shou...*/], this, ::STRINGS[1/*"/usr/local/...*/], 2759, ::STRINGS[72/*"set_Motion"*/]);
}
...
void StructuredNavigation::OnUpdated()
{
    ...
    if (_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[69/*"Updated cal...*/], this, ::STRINGS[1/*"/usr/local/...*/], 2915, ::STRINGS[70/*"OnUpdated"*/]);
        return;
    }
...
{
    VisualNavigation::ActiveIndexName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[73/*"ActiveIndex"*/]);
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[25/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[48/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.VisualNavigation>*/], ::STRINGS[27/*"goto"*/], uDelegate::New(::TYPES[49/*Uno.Action<Fuse.Scripting.Context, Fuse.Navigation.VisualNavigation, object[]>*/], (void*)VisualNavigation__gotoNode_fn), 2)));
}

static void VisualNavigation_build(uType* type)
{
    ::STRINGS[73] = uString::Const("ActiveIndex");
    ::STRINGS[27] = uString::Const("goto");
    ::STRINGS[74] = uString::Const("Navigation.goto() : Argument must be a node object");
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/0.41.3/$.uno");
    ::STRINGS[75] = uString::Const("gotoNode");
    ::TYPES[24] = ::g::Uno::Type_typeof();
    ::TYPES[25] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
...
void VisualNavigation::gotoNode(::g::Fuse::Scripting::Context* c, VisualNavigation* nav, uArray* args)
{
    ...
    if (target != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[74/*"Navigation....*/], nav, ::STRINGS[1/*"/usr/local/...*/], 3921, ::STRINGS[75/*"gotoNode"*/]);
}
// }
