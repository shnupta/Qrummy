...
// /usr/local/share/uno/Packages/Fuse.Reactive/0.41.3/subscription/$.uno
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.41.3/reactive/$.uno
// ------------------------------------------------------------
...
static void BindingTypes_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.41.3/reactive/$.uno");
...
// /usr/local/share/uno/Packages/Fuse.Reactive/0.41.3/$.uno
// --------------------------------------------------------

// private sealed class EventBinding.CallClosure :726
// {
static void EventBinding__CallClosure_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive/0.41.3/$.uno");
...
// public CallClosure(Fuse.Scripting.IScriptEvent args, object sender) :735
...
// public void AddBool(string key, bool value) :791
...
// public void AddDouble(string key, double value) :786
...
// public void AddString(string key, string value) :776
...
// public void Call() :750
void EventBinding__CallClosure__Call_fn(EventBinding__CallClosure* __this)
{
    __this->Call();
}

// public CallClosure New(Fuse.Scripting.IScriptEvent args, object sender) :735
...
// public CallClosure(Fuse.Scripting.IScriptEvent args, object sender) [instance] :735
...
// public void AddString(string key, string value) [instance] :776
void EventBinding__CallClosure::AddString(uString* key, uString* value)
{
    AddObject(key, value);
}

// public void Call() [instance] :750
void EventBinding__CallClosure::Call()
{
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[11/*Fuse.Scripting.ScriptException*/]))
        {
            ...
            ::g::Fuse::Diagnostics::UserScriptError(::STRINGS[9/*"JavaScript ...*/], ex, this, ::STRINGS[10/*"/usr/local/...*/], 766, ::STRINGS[11/*"Call"*/]);
        }
        else throw __t;
    }
}

// public CallClosure New(Fuse.Scripting.IScriptEvent args, object sender) [static] :735
...
// internal static class Console :97
// {
...
// private static object Dir(object[] args) :118
void Console__Dir_fn(uArray* args, uObject** __retval)
{
    *__retval = Console::Dir(args);
}

// private static void Dir(Uno.Text.StringBuilder builder, object obj, [int maxDepth], [int indent]) :130
...
// private static void Dir(Uno.Text.StringBuilder builder, object obj, [int maxDepth], [int indent]) [static] :130
...
// private static void Indent(Uno.Text.StringBuilder builder, int indent) [static] :199
...
// public static void Init(Fuse.Scripting.Context c) [static] :99
...
// private static object Log(object[] args) [static] :108
...
void DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if ((::g::Fuse::Scripting::Marshal__TryConvertTo1_fn(__types[1], newValue, &value, &ret3), ret3))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(uPtr(e)->ToString(), Target(), ::STRINGS[10/*"/usr/local/...*/], 395, ::STRINGS[29/*"TryPushAsMa...*/]);
        }
    }
}
...
// internal static class DebugLog :79
// {
...
// public static void Init(Fuse.Scripting.Context c) :81
void DebugLog__Init_fn(::g::Fuse::Scripting::Context* c)
{
    DebugLog::Init(c);
}

// private static object Log(object[] args) :86
void DebugLog__Log_fn(uArray* args, uObject** __retval)
{
    *__retval = DebugLog::Log(args);
}

// public static void Init(Fuse.Scripting.Context c) [static] :81
...
// private static object Log(object[] args) [static] :86
...
// private sealed class JavaScript.EvaluateDataContext :1527
// {
...
// public EvaluateDataContext(Fuse.Reactive.ThreadWorker worker, Fuse.Reactive.JavaScript js) :1533
...
// private void Evaluate() :1541
void JavaScript__EvaluateDataContext__Evaluate_fn(JavaScript__EvaluateDataContext* __this)
{
    __this->Evaluate();
}

// public EvaluateDataContext New(Fuse.Reactive.ThreadWorker worker, Fuse.Reactive.JavaScript js) :1533
...
// private void SetDataContext() :1550
void JavaScript__EvaluateDataContext__SetDataContext_fn(JavaScript__EvaluateDataContext* __this)
{
    __this->SetDataContext();
}

// public EvaluateDataContext(Fuse.Reactive.ThreadWorker worker, Fuse.Reactive.JavaScript js) [instance] :1533
...
// private void Evaluate() [instance] :1541
...
// private void SetDataContext() [instance] :1550
void JavaScript__EvaluateDataContext::SetDataContext()
{
    uPtr(_js)->SetDataContext(_dc);
}

// public EvaluateDataContext New(Fuse.Reactive.ThreadWorker worker, Fuse.Reactive.JavaScript js) [static] :1533
...
// public sealed class EventBinding :687
// {
...
// private void ProcessQueuedEvents() :698
void EventBinding__ProcessQueuedEvents_fn(EventBinding* __this)
{
    __this->ProcessQueuedEvents();
}

// public EventBinding(string key) [instance] :690
void EventBinding::ctor_2(uString* key)
{
    ctor_1(key);
}

// public void OnEvent(object sender, Uno.EventArgs args) [instance] :797
...
// private void ProcessQueuedEvents() [instance] :698
...
// public EventBinding New(string key) [static] :690
...
// public sealed class JavaScript :1452
// {
// static JavaScript() :1452
...
static void JavaScript_build(uType* type)
{
    ...
    ::STRINGS[35] = uString::Const("JavaScript error in ");
    ::STRINGS[36] = uString::Const(" fixed!");
    ::STRINGS[10] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive/0.41.3/$.uno");
    ::STRINGS[37] = uString::Const("EvaluateModule");
    ::STRINGS[38] = uString::Const("JavaScript error");
...
// protected override sealed void OnUnrooted() :1478
...
// private void SetDataContext(object newDc) :1519
void JavaScript__SetDataContext_fn(JavaScript* __this, uObject* newDc)
{
    __this->SetDataContext(newDc);
}

// internal static Fuse.Reactive.ThreadWorker get_Worker() :1456
...
// public JavaScript(Uno.UX.NameTable nameTable) [instance] :1461
...
// private void DispatchEvaluate() [instance] :1510
...
// private object EvaluateExports() [instance] :1558
uObject* JavaScript::EvaluateExports()
{
    EvaluateModule();

    if (_moduleResult != NULL)
        return uPtr(uPtr(_moduleResult)->Object)->Item(::STRINGS[34/*"exports"*/]);

    return NULL;
}

// private void EvaluateModule() [instance] :1570
void JavaScript::EvaluateModule()
{
...

    {
        ...
        if (newModuleResult->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[35/*"JavaScript ...*/], FileName()), ::STRINGS[36/*" fixed!"*/]), this, ::STRINGS[10/*"/usr/local/...*/], 1585, ::STRINGS[37/*"EvaluateMod...*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserScriptError(::STRINGS[38/*"JavaScript ...*/], se, this, ::STRINGS[10/*"/usr/local/...*/], 1596, ::STRINGS[37/*"EvaluateMod...*/]);
...
// public JavaScript New(Uno.UX.NameTable nameTable) [static] :1461
...
// internal static Fuse.Reactive.ThreadWorker get_Worker() [static] :1456
...
// internal sealed class RootableScriptModule :2003
// {
...
// public RootableScriptModule(Fuse.Reactive.ThreadWorker worker, Uno.UX.NameTable names) :2009
...
// protected override sealed void CallModuleFunc(Fuse.Scripting.Function moduleFunc, object[] args) :2046
...
// private void EnsureClassInstanceRooted() :2021
void RootableScriptModule__EnsureClassInstanceRooted_fn(RootableScriptModule* __this)
{
    __this->EnsureClassInstanceRooted();
}

// public override sealed void Evaluate(Fuse.Scripting.Context c, Fuse.Scripting.ModuleResult result) :2015
...
// protected override sealed string GenerateArgs(Fuse.Scripting.Context c, Fuse.Scripting.ModuleResult result, Uno.Collections.List<object> args) :2027
...
// public RootableScriptModule New(Fuse.Reactive.ThreadWorker worker, Uno.UX.NameTable names) :2009
...
// public RootableScriptModule(Fuse.Reactive.ThreadWorker worker, Uno.UX.NameTable names) [instance] :2009
...
// private void EnsureClassInstanceRooted() [instance] :2021
...
// public RootableScriptModule New(Fuse.Reactive.ThreadWorker worker, Uno.UX.NameTable names) [static] :2009
...
{
    ::STRINGS[27] = uString::Const(".");
    ::STRINGS[41] = uString::Const("Cannot access disposed PathSubscription");
    ::STRINGS[42] = uString::Const("Data binding to '");
    ::STRINGS[43] = uString::Const("': expected single value, got array");
    ::STRINGS[44] = uString::Const("': expected single value, got array of length ");
    ::TYPES[22] = ::g::Uno::IDisposable_typeof();
    ::TYPES[23] = ::g::Fuse::Scripting::Observable_typeof();
...
{
    if (_isDisposed)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[41/*"Cannot acce...*/]));
...
void SegmentObserver::OnAdd(uObject* addedValue)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[42/*"Data bindin...*/], _key), ::STRINGS[43/*"': expected...*/])));
}
...
void SegmentObserver::OnNewAll(::g::Fuse::Scripting::ListMirror* values)
{
    ...
    if (uPtr(values)->Length() > 0)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[42/*"Data bindin...*/], _key), ::STRINGS[44/*"': expected...*/]), uBox<int>(::TYPES[13/*int*/], uPtr(values)->Length()))));
}
...
// internal partial sealed class ThreadWorker :2064
// {
static void ThreadWorker_build(uType* type)
{
    ::STRINGS[45] = uString::Const("Skipped Exception");
    ::STRINGS[10] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive/0.41.3/$.uno");
    ::STRINGS[46] = uString::Const("CheckAndThrow");
    ::STRINGS[47] = uString::Const("ThreadWorked failed");
    ::STRINGS[48] = uString::Const("Run");
    ::STRINGS[49] = uString::Const("Could not create script context");
...
// public void Dispose() :2112
void ThreadWorker__Dispose_fn(ThreadWorker* __this)
{
    __this->Dispose();
}

// private Uno.Threading.IDispatcher Fuse.Scripting.IThreadWorker.get_Dispatcher() :2066
...
// private Fuse.Scripting.Function Fuse.Scripting.IThreadWorker.get_Observable() :2067
...
// public ThreadWorker() [instance] :2091
...
// public void CheckAndThrow() [instance] :2237
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[45/*"Skipped Exc...*/], next, this, ::STRINGS[10/*"/usr/local/...*/], 2243, ::STRINGS[46/*"CheckAndThrow"*/]);
...
// public Fuse.Scripting.Context get_Context() [instance] :2078
::g::Fuse::Scripting::Context* ThreadWorker::Context()
{
    return ThreadWorker::_context_;
}

// public void Dispose() [instance] :2112
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[47/*"ThreadWorke...*/], e, this, ::STRINGS[10/*"/usr/local/...*/], 2128, ::STRINGS[48/*"Run"*/]);
        ::g::Uno::Threading::ConcurrentQueue__Enqueue_fn(uPtr(_exceptionQueue), e);
    }
}

// private void RunInner() [instance] :2133
...

    {
...

        {
            ...
            if (ThreadWorker::_context_ == NULL)
            {
                ...
                if (ThreadWorker::_context_ == NULL)
                    U_THROW(::g::Uno::Exception::New2(::STRINGS[49/*"Could not c...*/]));
...
// internal static Fuse.Scripting.Context CreateContext(Fuse.Scripting.IThreadWorker worker) [static] :2069
...
// public ThreadWorker New() [static] :2091
