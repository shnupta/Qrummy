...
// /usr/local/share/uno/Packages/Fuse.Elements/0.41.3/resources/$.uno
// ------------------------------------------------------------------
...
static void ImageSource_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/0.41.3/resources/$.uno");
...
{
    ::g::Fuse::Diagnostics::UnknownException(::STRINGS[10/*"ImageSource...*/], e, this, ::STRINGS[11/*"/usr/local/...*/], 608, ::STRINGS[12/*"OnError"*/]);
