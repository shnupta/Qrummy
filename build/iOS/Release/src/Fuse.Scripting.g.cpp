...
void Context__MethodClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptMethod* m, ::g::Fuse::Scripting::Context* context)
{
    _m = m;
    _context = context;
    ::g::Fuse::Scripting::Function* factory = uCast< ::g::Fuse::Scripting::Function*>(uPtr(_context)->Evaluate(::g::Uno::String::op_Addition2(uPtr(m)->Name, ::STRINGS[25/*" (ScriptMet...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[62/*"(function (...*/], uPtr(m)->Name), ::STRINGS[63/*" = function...*/])), ::TYPES[20/*Fuse.Scripting.Function*/]);
...
::g::Fuse::Scripting::ModuleResult* Module::Evaluate1(::g::Fuse::Scripting::Context* c, uString* id)
{
    ...
    module->Item(::STRINGS[65/*"disposed"*/], c->NewArray(uArray::New(::TYPES[5/*object[]*/], 0)));
...
void ModuleResult::OnDisposed()
{
    ...
    {
        ::g::Fuse::Scripting::Array* disposed = uAs< ::g::Fuse::Scripting::Array*>(uPtr(Object)->Item(::STRINGS[65/*"disposed"*/]), ::TYPES[21/*Fuse.Scripting.Array*/]);
...
void NativeEventEmitterModule::ResetListenersJS()
{
    ...
    uObject* ret7;
    uDelegate* ret8;
    uPtr(_this)->CallMethod(::STRINGS[68/*"removeAllLi...*/], uArray::New(::TYPES[5/*object[]*/], 0));
    uObject* lg = ::g::Uno::Threading::LockGuard::Acquire(_mutex);
...
void NativeModule__Evaluate_fn(NativeModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    ::g::Fuse::Scripting::Object* obj = uAs< ::g::Fuse::Scripting::Object*>(uPtr(module)->Item(::STRINGS[64/*"exports"*/]), ::TYPES[10/*Fuse.Scripting.Object*/]);
...
void Observable::ctor_2(::g::Fuse::Scripting::Context* context, ::g::Fuse::Scripting::Object* obj, bool supressCallback)
{
    ...
    uPtr(obj)->CallMethod(::STRINGS[70/*"addSubscriber"*/], uArray::Init<uObject*>(::TYPES[5/*object[]*/], 2, (::g::Fuse::Scripting::Function*)_observeChange, uBox(::TYPES[55/*bool*/], supressCallback)));
}
...
{
    uPtr(_observable)->CallMethod(::STRINGS[81/*"removeSubsc...*/], uArray::Init<uObject*>(::TYPES[5/*object[]*/], 1, (::g::Fuse::Scripting::Function*)_observeChange));
    _observeChange = NULL;
    _observable = NULL;
}
...
{
    uPtr(o)->CallMethod(::STRINGS[82/*"on"*/], uArray::Init<uObject*>(::TYPES[5/*object[]*/], 2, (uObject*)_eventName, (uDelegate*)_listener));
}
...
static void ScriptModule__RequireContext_build(uType* type)
{
    ...
    ::STRINGS[103] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting/0.41.3/$.uno");
...
{
    if (uPtr(args)->Length() != 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[97/*"require(): ...*/], uBox<int>(::TYPES[38/*int*/], uPtr(args)->Length())), ::STRINGS[98/*" provided"*/])));
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[101/*"JavaScript ...*/], path), ::STRINGS[102/*" was fixed!"*/]), this, ::STRINGS[103/*"/usr/local/...*/], 204, ::STRINGS[104/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[101/*"JavaScript ...*/], path), ::STRINGS[105/*" line "*/]), uBox<int>(::TYPES[38/*int*/], uPtr(e)->LineNumber())), ::STRINGS[106/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[103/*"/usr/local/...*/], 214, ::STRINGS[104/*"Require"*/]);
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, ::g::Fuse::Scripting::Context* c, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[113/*"Cannot call...*/], __this, ::STRINGS[7/*"/usr/local/...*/], 2181, ::STRINGS[114/*"Call"*/]);
            return *__retval = NULL, void();
        }
...
{
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[72/*"clear"*/], uArray::Init<uObject*>(::TYPES[5/*object[]*/], 1, uBox<int>(::TYPES[38/*int*/], _origin)));
}
...
void Observable__Subscription::ReplaceAllExclusive(uType* __type, uArray* newValues)
{
    ...
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[127/*"replaceAllW...*/], uArray::Init<uObject*>(::TYPES[5/*object[]*/], 2, sa, uBox<int>(::TYPES[38/*int*/], _origin)));
}
...
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[128/*"Unexpected ...*/], this, ::STRINGS[7/*"/usr/local/...*/], 1504, ::STRINGS[129/*"SetExclusive"*/]);
        return;
    }

    try
    {
        uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[130/*"setValueWit...*/], uArray::Init<uObject*>(::TYPES[5/*object[]*/], 2, (uObject*)uPtr(uPtr(_om)->_context)->Unwrap(newValue), uBox<int>(::TYPES[38/*int*/], _origin)));
    }
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[67/*Fuse.Scripting.ScriptException*/]))
        {
            ...
            ::g::Fuse::Diagnostics::UserScriptError(::STRINGS[131/*"Failed to s...*/], ex, this, ::STRINGS[7/*"/usr/local/...*/], 1516, ::STRINGS[129/*"SetExclusive"*/]);
        }
        else throw __t;
    }
}
