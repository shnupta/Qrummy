...
{
    ::STRINGS[73] = uString::Const("visual");
    type->SetInterfaces(
...
void VisualEventArgs::ctor_1(::g::Fuse::Visual* visual)
{
    ...
    if (visual == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[73/*"visual"*/]));
...
{
    ::STRINGS[74] = uString::Const("Wrapped Exception");
    type->SetFields(3);
}
...
{
    ctor_2(::STRINGS[74/*"Wrapped Exc...*/], inner);
}
